        ...
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          ...
          <button onClick={()=>setDone(!done)}
            style={{background:done?"#0a1228":"transparent",border:"1px solid #0a1228",
              color:done?"#fff":"#0a1228",padding:"7px 18px",fontSize:9,letterSpacing:2,
    ...
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#ffffff",
          ...
          <div id="pg" style={{display:"flex",flexDirection:"column"}}>
            {PRINTS.map((p,idx)=>(
              <div key={p.id} className="hs"
                style={{display:"flex",alignItems:"stretch",
                  borderBottom:"1px solid #0a1228",background:"#ffffff",cursor:"pointer"}}
                onClick={()=>setLb(idx)}
                onMouseEnter={e=>e.currentTarget.style.background="#ffffff"}
                onMouseLeave={e=>e.currentTarget.style.background="#ffffff"}>
      ...
      {sec==="coffret"&&(
        <div style={{maxWidth:1140,margin:"60px auto",padding:"0 14px 70px"}}>
          ...
          {/* ──────── Hero : vue d'ensemble ──────── */}
          <div style={{background:"#ffffff",border:"1px solid #0a1228",marginBottom:24}}>
      ...
      {sec==="insitu"&&(
        <div style={{maxWidth:1140,margin:"60px auto",padding:"0 14px 70px"}}>
          ...
          <div style={{background:"#ffffff",border:"1px solid #0a1228",marginBottom:2}}>
