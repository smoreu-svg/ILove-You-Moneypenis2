...
const FLAGS={FR:"🇫🇷",EN:"🇬🇧",ES:"🇪🇸",PT:"🇧🇷",DE:"🇩🇪",IT:"🇮🇹","中":"🇨🇳","日":"🇯🇵"};
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:500,
            fontSize:13,letterSpacing:3,color:"#1a1a1a",textTransform:"uppercase"}}>
            I.L.Y.M. · {p.num}
          </span>
        </div>
          ...
          {txt&&(
            <button onClick={()=>setShowText(!showText)}
              style={{background:showText?"#1a1a1a":"none",border:"1px solid #cfcbc4",
                color:showText?"#fff":"#1a1a1a",padding:"4px 10px",fontSize:8,letterSpacing:2,
        ...
        {showText&&txt&&(
          <div style={{background:"#ffffff",borderBottom:"1px solid #cfcbc4",
            ...
            <pre style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:11,
              color:"#1a1a1a",lineHeight:1.9,whiteSpace:"pre-wrap",margin:0}}>{txt}</pre>
          </div>
        )}
  ...
  return(
    <div style={{padding:"18px 0",borderBottom:"1px solid #cfcbc4"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
        <div>
          <p style={{color:"#1a1a1a",fontSize:13,fontWeight:400}}>{label}</p>
          <div style={{display:"flex",alignItems:"center",gap:8,marginTop:5}}>
            <div style={{width:70,height:1,background:"#cfcbc4"}}>
              <div style={{width:`${pct}%`,height:"100%",background:"#1a1a1a"}}/>
            </div>
            <span style={{color:"#1a1a1a",fontSize:9,fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
              {rem}/{total}
            </span>
          </div>
        </div>
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          ...
          <button onClick={()=>setDone(!done)}
            style={{background:done?"#1a1a1a":"transparent",border:"1px solid #b8b4b0",
              color:done?"#fff":"#1a1a1a",padding:"7px 18px",fontSize:9,letterSpacing:2,
  ...
  return(
    <div style={{maxWidth:680,margin:"100px auto",padding:"0 24px",textAlign:"center"}}>
      <h2 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",fontWeight:400,
        fontSize:"clamp(22px,4vw,38px)",color:"#1a1a1a",marginBottom:20}}>{title}</h2>
      <div style={{width:36,height:1,background:"#cfcbc4",margin:"0 auto 20px"}}/>
      <p style={{color:"#1a1a1a",fontSize:12,letterSpacing:1,
        fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,marginBottom:10}}>{soon}</p>
      {contact&&<p style={{color:"#1a1a1a",fontSize:11,
...
export default function App(){
  ...
  // Fallback : si onAnimationEnd ne fire pas, force introDone après 10.3s
  useEffect(()=>{
    if(introDone) return;
    const tm=setTimeout(()=>setIntroDone(true),10300);
    ...
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#ffffff",
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .nb{background:none;border:none;color:#1a1a1a;font-size:11px;letter-spacing:3px;
        ...
        .nb.gr{color:#1a1a1a;cursor:default;pointer-events:none;}
        ...
        .bs:hover{opacity:.8;}
        .bg{background:none;border:1px solid #b8b4b0;color:#1a1a1a;padding:14px 30px;
          font-size:9px;letter-spacing:3px;text-transform:uppercase;cursor:pointer;
        ...
        @keyframes introBounce {
          /* — I. Apparition douce — */
          0%   { transform: scale(0.1) rotate(0deg);                                                            animation-timing-function: ease-out; }
          5%   { transform: scale(0.5) rotate(25deg);                                                           animation-timing-function: cubic-bezier(.7,0,.4,1); }

          /* — II. 1ʳᵉ explosion : centrée, REMPLIT le viewport (≈85% du vmin) sans sortir — */
          13%  { transform: scale(calc(min(85vw, 85vh) / 104px)) rotate(220deg);                                animation-timing-function: cubic-bezier(.85,0,.15,1); }
          /* Rétrécissement éclair */
          20%  { transform: scale(0.18) rotate(380deg);                                                         animation-timing-function: ease-in; }

          /* — III. 2ᵉ explosion : décentrée haut-droite, reste dans le cadre — */
          28%  { transform: translate(10vw, -10vh) scale(calc(min(55vw, 55vh) / 104px)) rotate(560deg);         animation-timing-function: cubic-bezier(.8,0,.2,1); }
          /* Rebond */
          34%  { transform: translate(9vw, -8vh) scale(0.25) rotate(700deg);                                    animation-timing-function: cubic-bezier(.34,1.4,.64,1); }

          /* — IV. Billard · 5 segments diagonaux contenus dans le cadre — */
          41%  { transform: translate(-20vw, -16vh) scale(0.5) rotate(840deg);                                  animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          49%  { transform: translate(20vw, 4vh) scale(0.55) rotate(990deg);                                    animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          56%  { transform: translate(-10vw, 18vh) scale(0.6) rotate(1140deg);                                  animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          63%  { transform: translate(-20vw, -4vh) scale(0.6) rotate(1290deg);                                  animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          70%  { transform: translate(15vw, -18vh) scale(0.65) rotate(1440deg);                                 animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          /* Convergence vers le centre */
          76%  { transform: translate(0, 0) scale(0.7) rotate(1560deg);                                         animation-timing-function: cubic-bezier(.9,0,.1,1); }

          /* — V. 3ᵉ explosion : décentrée bas-gauche, plus grosse (≈65% du vmin) mais contenue — */
          82%  { transform: translate(-8vw, 8vh) scale(calc(min(65vw, 65vh) / 104px)) rotate(1740deg);          animation-timing-function: cubic-bezier(.7,0,.3,1); }
          /* Pulvérisation au centre */
          88%  { transform: scale(0.15) rotate(1900deg);                                                        animation-timing-function: cubic-bezier(.34,1.6,.64,1); }
          /* Overshoot */
          94%  { transform: scale(1.4) rotate(2080deg);                                                         animation-timing-function: cubic-bezier(.34,1.2,.64,1); }

          /* — VI. Atterrissage à l'endroit — */
          100% { transform: scale(1) rotate(2160deg); }
        }
        .intro-logo { animation: introBounce 10s linear forwards; transform-origin: 50% 50%; }
        ...
        <div style={{position:"fixed",inset:0,zIndex:9999,background:"#ffffff",
          ...
          <div className="fade-in" style={{position:"fixed",top:"calc(14px + env(safe-area-inset-top,0px))",
            ...
            <button onClick={()=>setLangOpen(!langOpen)}
              style={{background:"#ffffff",border:"1px solid #cfcbc4",
                color:"#1a1a1a",padding:"4px 8px",fontSize:18,lineHeight:1,
                cursor:"pointer",fontFamily:"'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif",
                display:"flex",alignItems:"center",gap:4,transition:"all .15s"}}
              title={lang}>
              {FLAGS[lang]} <span style={{fontSize:8,color:"#1a1a1a"}}>▾</span>
            </button>
            {langOpen&&(
              <div style={{position:"absolute",top:"calc(100% + 4px)",right:0,
                background:"#ffffff",border:"1px solid #cfcbc4",
                minWidth:44,boxShadow:"0 4px 20px rgba(0,0,0,0.08)"}}>
                {LANGS.filter(l=>l!==lang).map(l=>(
                  <button key={l}
                    onClick={()=>{setLang(l);setLangOpen(false);}}
                    style={{display:"block",width:"100%",background:"none",border:"none",
                      borderBottom:"1px solid #f0eee9",padding:"8px 0",fontSize:18,lineHeight:1,
                      cursor:"pointer",fontFamily:"'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif",
          ...
          <h1 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",fontWeight:400,
            fontSize:"clamp(22px,5.4vw,34px)",color:"#1a1a1a",marginBottom:4,lineHeight:1.2}}>
            I Love You Moneypenis
          </h1>
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:10,
            letterSpacing:3,color:"#1a1a1a",marginBottom:4,textTransform:"uppercase"}}>
            Sébastien Moreu & André Vaszkievicz · Paris 2024
          </p>
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:9,
            letterSpacing:4,color:"#1a1a1a",marginBottom:22,textTransform:"uppercase"}}>
            {t.aw}
          </p>
          ...
          <div style={{background:"#ffffff",border:"1px solid #cfcbc4",
            ...
            <p style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
              fontWeight:400,fontSize:13.5,color:"#1a1a1a",marginBottom:10,
              letterSpacing:".02em"}}>
              {t.nat}
            </p>
            {(showNote?t.naf.split("\n\n"):[t.naf.split("\n\n")[0]]).map((para,j)=>(
              <p key={j} style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:11,color:"#1a1a1a",lineHeight:1.7,marginBottom:9}}>
                {para}
              </p>
            ))}
            <button onClick={()=>setShowNote(!showNote)}
              style={{background:"none",border:"none",padding:"4px 0",marginTop:2,
                ...
                fontSize:9.5,letterSpacing:2,color:"#1a1a1a",
          ...
          <div style={{background:"#ffffff",border:"1px solid #cfcbc4",
            ...
            <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:10.5,
              color:"#1a1a1a",lineHeight:1.6,marginBottom:11}}>{t.am}</p>
            ...
            <label style={{display:"flex",alignItems:"flex-start",gap:9,
              ...
              <input type="checkbox" checked={ck1} onChange={e=>setCk1(e.target.checked)}
                style={{marginTop:2,width:14,height:14,accentColor:"#1a1a1a",
                  flexShrink:0,cursor:"pointer"}}/>
              <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:10.5,color:"#1a1a1a",lineHeight:1.45}}>{t.ck1}</span>
            </label>
            ...
            <label style={{display:"flex",alignItems:"flex-start",gap:9,
              ...
              <input type="checkbox" checked={ck2} onChange={e=>setCk2(e.target.checked)}
                style={{marginTop:2,width:14,height:14,accentColor:"#1a1a1a",
                  flexShrink:0,cursor:"pointer"}}/>
              <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:10.5,color:"#1a1a1a",lineHeight:1.45}}>{t.ck2}</span>
            </label>
          ...
          <div style={{marginTop:4,display:"flex",gap:16,fontSize:10,color:"#1a1a1a",
            letterSpacing:1,fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
            <a href={`https://${t.si}`} style={{color:"#1a1a1a",textDecoration:"none"}}>{t.si}</a>
            <span>·</span>
            <a href={`https://${t.pv}`} style={{color:"#1a1a1a",textDecoration:"none"}}>{t.pv}</a>
          </div>
          </div>{/* /fade-in wrapper */}
        </div>
      )}
      ...
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:800,
        ...
        <div style={{height:52,display:"flex",alignItems:"center",
          ...
          <div style={{display:"flex",alignItems:"center",cursor:"pointer",flexShrink:0}}
            ...
            <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:500,
              fontSize:11,letterSpacing:3.5,color:"#1a1a1a",whiteSpace:"nowrap"}}>
              A.V.S.M PRINTS
            </span>
          </div>
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,flexShrink:0}}>
            ...
            <div style={{position:"relative"}}>
              ...
              {langOpen&&(
                <div style={{position:"absolute",top:"calc(100% + 4px)",right:0,
                  background:"#ffffff",border:"1px solid #cfcbc4",zIndex:900,
                  minWidth:44,boxShadow:"0 4px 20px rgba(0,0,0,0.08)"}}>
                  {LANGS.filter(l=>l!==lang).map(l=>(
                    <button key={l}
                      onClick={()=>{setLang(l);setLangOpen(false);}}
                      style={{display:"block",width:"100%",background:"none",border:"none",
                        borderBottom:"1px solid #f0eee9",padding:"8px 0",fontSize:16,lineHeight:1,
                        cursor:"pointer",fontFamily:"'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif",
                        color:"#1a1a1a",textAlign:"center"}}
                      title={l}>
                      {FLAGS[l]}
            ...
            <button onClick={()=>{if(!ageOk){setDis(false);}else{setAgeOk(false);}setLangOpen(false);}}
              style={{background:"none",
                ...
                color:ageOk?"#1a1a1a":"#1a1a1a",padding:"5px 7px",fontSize:8,
            ...
            <button onClick={()=>{setMenuOpen(!menuOpen);setLangOpen(false);}}
              ...
              <span style={{display:"block",width:18,height:1.5,background:"#1a1a1a",
                transition:"all .25s",
                transform:menuOpen?"rotate(45deg) translate(4px,4px)":"none"}}/>
              <span style={{display:"block",width:18,height:1.5,
                background:menuOpen?"transparent":"#1a1a1a",transition:"all .25s"}}/>
              <span style={{display:"block",width:18,height:1.5,background:"#1a1a1a",
                transition:"all .25s",
                transform:menuOpen?"rotate(-45deg) translate(4px,-4px)":"none"}}/>
            </button>
      ...
      {sec==="portfolio"&&(<>
        <div style={{background:"#ffffff",textAlign:"center",
          ...
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:8,
            letterSpacing:5,color:"#1a1a1a",marginBottom:12,textTransform:"uppercase"}}>
            {t.hl}
          </p>
          <h1 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",fontWeight:400,
            fontSize:"clamp(28px,6.5vw,72px)",lineHeight:1.15,color:"#1a1a1a",
            marginBottom:12,whiteSpace:"pre-line"}}>{t.ht}</h1>
          <p style={{color:"#1a1a1a",fontSize:13,letterSpacing:2,marginBottom:4,fontWeight:400}}>
            {t.hs}
          </p>
          <p style={{color:"#1a1a1a",fontSize:11,letterSpacing:1,marginBottom:20}}>{t.hy}</p>
          <p style={{color:"#1a1a1a",fontSize:13,lineHeight:1.9,whiteSpace:"pre-line",
        ...
        <div style={{maxWidth:860,margin:"0 auto",padding:"40px 14px 70px"}}>
          ...
          <div className="hs"
            style={{display:"flex",alignItems:"stretch",
              borderBottom:"1px solid #cfcbc4",background:"#ffffff",marginBottom:60}}
            ...
            <div style={{flex:"0 0 auto",width:"40%",display:"grid",
              gridTemplateColumns:"1fr 1fr",gap:6,padding:6,background:"#fafafa"}}>
              <div onClick={()=>setPlanchePreview("recto")}
                ...
                <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                  fontSize:8,letterSpacing:3,color:"#1a1a1a",textTransform:"uppercase"}}>Recto</span>
              </div>
              <div onClick={()=>setPlanchePreview("verso")}
                ...
                <img src={IMG.planche_verso} alt="Verso"
                  style={{width:"100%",height:"auto",display:"block"}}/>
                <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                  fontSize:8,letterSpacing:3,color:"#1a1a1a",textTransform:"uppercase"}}>Verso</span>
              </div>
            </div>
            ...
            <div style={{flex:1,padding:"20px 18px",display:"flex",
              ...
              <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:500,
                fontSize:"clamp(13px,1.8vw,18px)",color:"#1a1a1a",letterSpacing:3,
                textTransform:"uppercase",lineHeight:1.3}}>
                I.L.Y.M. · 0
              </p>
              <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:10,color:"#1a1a1a"}}>{t.op} · Recto-verso</p>
              <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:9,color:"#1a1a1a",lineHeight:1.6}}>{t.pl0}</p>
            </div>
          </div>
          ...
          <div style={{display:"flex",alignItems:"baseline",gap:12,marginBottom:6}}>
            ...
            <span style={{color:"#1a1a1a",fontSize:9,letterSpacing:3,
              fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>— XI</span>
          </div>
          <p style={{color:"#1a1a1a",fontSize:12,lineHeight:1.9,whiteSpace:"pre-line",
            ...
            {PRINTS.map((p,idx)=>(
              <div key={p.id} className="hs"
                ...
                <div style={{flex:1,padding:"20px 18px",display:"flex",
                  ...
                  <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                    fontSize:10,color:"#1a1a1a",lineHeight:1.5}}>{p.tech}</p>
                  <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                    fontSize:9,color:"#1a1a1a",lineHeight:1.6,marginTop:2}}>{t.tech_info}</p>
                  <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                    fontSize:8,color:"#1a1a1a",letterSpacing:2,textTransform:"uppercase",
                    marginTop:6}}>
                    {t.mg}
                  </p>
                </div>
      ...
      {sec==="video"&&(
        <div style={{maxWidth:960,margin:"60px auto",padding:"0 18px 70px"}}>
          ...
          <p style={{color:"#1a1a1a",fontSize:11,letterSpacing:1,
          ...
          <p style={{color:"#1a1a1a",fontSize:8,letterSpacing:2,marginTop:8,
      ...
      {sec==="coffret"&&(
        <div style={{maxWidth:1140,margin:"60px auto",padding:"0 14px 70px"}}>
          <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:6}}>
            <button onClick={()=>goSec("portfolio")}
              style={{background:"none",border:"none",cursor:"pointer",
                color:"#1a1a1a",fontSize:18,lineHeight:1,padding:"0 4px 0 0"}}>←</button>
            <h2 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
              fontWeight:400,fontSize:"clamp(20px,4vw,38px)"}}>{t.ct}</h2>
          </div>
          <div style={{color:"#1a1a1a",fontSize:12,letterSpacing:1,
          ...
          <div style={{background:"#ffffff",border:"1px solid #cfcbc4",marginBottom:24}}>
            ...
            <p style={{padding:"8px 14px",color:"#1a1a1a",fontSize:10,letterSpacing:1,
          ...
          <h3 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
            ...
            <span style={{fontFamily:"'Space Grotesk',sans-serif",fontStyle:"normal",
              fontSize:9,letterSpacing:3,color:"#1a1a1a",marginLeft:14,
            ...
            {[{src:IMG.coffret_pf_print,cap:"Coffret PF fermé · Tirage I extrait"},
              ...
              <div key={i} style={{background:"#ffffff",border:"1px solid #cfcbc4"}}>
                <img src={im.src} alt="" draggable={false}
                  onContextMenu={e=>e.preventDefault()} style={{width:"100%",display:"block"}}/>
                <p style={{padding:"6px 10px",color:"#1a1a1a",fontSize:9,
        ...
        <div style={{maxWidth:1140,margin:"60px auto",padding:"0 14px 70px"}}>
          ...
          <div style={{background:"#ffffff",border:"1px solid #cfcbc4",marginBottom:2}}>
            <img src={ageOk?IMG.inside:IMG.inside_blur} alt="" draggable={false}
              onContextMenu={e=>e.preventDefault()} style={{width:"100%",display:"block"}}/>
            <p style={{padding:"6px 12px",color:"#1a1a1a",fontSize:9,
              fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
      ...
      {sec==="shop"&&(
        <div style={{maxWidth:940,margin:"60px auto",padding:"0 18px 70px"}}>
            ...
            {EDS.map(e=>(
              <button key={e.key} onClick={()=>setEt(e.key)}
                style={{background:"none",border:"none",
                  ...
                  color:et===e.key?"#1a1a1a":"#1a1a1a",padding:"9px 22px",fontSize:9,
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24,marginBottom:8,
            ...
            <div>
              <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:8,
                letterSpacing:4,color:"#1a1a1a",marginBottom:8,textTransform:"uppercase"}}>
                {et==="pf"?t.pft:t.gft}
              </p>
              <p style={{fontSize:13,fontWeight:400,color:"#1a1a1a",marginBottom:5}}>
                {et==="pf"?t.pfc:t.gfc}
              </p>
              <p style={{color:"#1a1a1a",fontSize:11,marginBottom:5,
                fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>{t.sg}</p>
              <p style={{color:"#1a1a1a",fontSize:9,
                fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
                {et==="pf"?t.pfi:t.gfi}
              </p>
            </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(210px,1fr))",
            ...
            {[{ti:t.sh,bo:t.sb},{ti:t.py,bo:t.pb},{ti:t.co,bo:t.cb}].map(c=>(
              <div key={c.ti} style={{background:"#ffffff",border:"1px solid #cfcbc4",
                ...
                <p style={{color:"#1a1a1a",fontSize:12,lineHeight:1.9,
            ...
            <div key={i}>
              <div style={{display:"grid",gridTemplateColumns:"90px 1fr",gap:28,
                ...
                <div style={{paddingTop:3}}>
                  ...
                  <p style={{textAlign:"center",fontFamily:"'Space Grotesk',sans-serif",
                    fontWeight:400,fontSize:8,color:"#1a1a1a",letterSpacing:2,marginTop:8}}>
                    {a.i}
                  </p>
                </div>
                <div>
                  ...
                  {a.b.split("\n\n").map((para,j)=>(
                    <p key={j} style={{color:"#1a1a1a",fontSize:14,lineHeight:1.9,fontWeight:400,
                      marginBottom:12}}>
                      {para}
                    </p>
                  ))}
              ...
              {i===0&&(
                <div style={{display:"flex",flexDirection:"column",alignItems:"center",
                  ...
                  <p style={{textAlign:"center",fontFamily:"'Space Grotesk',sans-serif",
                    fontWeight:400,fontSize:8,color:"#1a1a1a",letterSpacing:2,marginTop:10,
                    fontStyle:"italic"}}>
                    S.M. & A.V.
                  </p>
                </div>
      ...
      <footer style={{borderTop:"1px solid #cfcbc4",
        ...
        <div style={{display:"flex",alignItems:"center",gap:7}}>
          <Logo sz={20}/>
          <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
            fontSize:8,letterSpacing:4,color:"#1a1a1a"}}>A.V.S.M PRINTS</span>
        </div>
        <p style={{color:"#1a1a1a",fontSize:8,whiteSpace:"pre-line",textAlign:"center",
          fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,letterSpacing:.3}}>
          {t.lg}
        </p>
        <a href={`https://${t.pv}`}
          style={{color:"#1a1a1a",fontSize:8,letterSpacing:1,textDecoration:"none",
