...
function LBox({prints,ci,ageOk,onClose,onPrev,onNext,t,lang}){
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(245,243,240,0.98)",zIndex:3000,
      display:"flex",flexDirection:"column"}} onClick={onClose}>

      {/* Header */}
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",
        padding:"10px 16px",borderBottom:"1px solid #dedad6",background:"#f5f3f0",
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,fontSize:9,
            color:"#8a8a85",letterSpacing:3}}>{p.num} / XI</span>
          ...
          {txt&&(
            <button onClick={()=>setShowText(!showText)}
              style={{background:showText?"#1a1a1a":"none",border:"1px solid #dedad6",
                color:showText?"#fff":"#5a5856",padding:"4px 10px",fontSize:8,letterSpacing:2,
                cursor:"pointer",fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                textTransform:"uppercase",transition:"all .2s"}}>
              {showText?"✕ Texte":"≡ Texte"}
            </button>
          )}
          <button onClick={onClose}
            style={{background:"none",border:"1px solid #dedad6",color:"#555",
        ...
        {showText&&txt&&(
          <div style={{background:"#ffffff",borderBottom:"1px solid #dedad6",
            ...
            <pre style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,fontSize:11,
              color:"#4a4846",lineHeight:1.9,whiteSpace:"pre-wrap",margin:0}}>{txt}</pre>
          </div>
        )}
      ...
      {/* Footer nav */}
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",
        padding:"8px 16px",borderTop:"1px solid #dedad6",background:"#f5f3f0",
  ...
  return(
    <div style={{padding:"18px 0",borderBottom:"1px solid #dedad6"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
        <div>
          <p style={{color:"#4a4846",fontSize:13,fontWeight:400}}>{label}</p>
          <div style={{display:"flex",alignItems:"center",gap:8,marginTop:5}}>
            <div style={{width:70,height:1,background:"#dedad6"}}>
              <div style={{width:`${pct}%`,height:"100%",background:"#1a1a1a"}}/>
            </div>
            <span style={{color:"#8a8a85",fontSize:9,fontFamily:"'Space Grotesk',sans-serif",fontWeight:300}}>
              {rem}/{total}
            </span>
          </div>
        </div>
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          ...
          <button onClick={()=>setDone(!done)}
            style={{background:done?"#1a1a1a":"transparent",border:"1px solid #c8c4c0",
              color:done?"#fff":"#4a4846",padding:"7px 18px",fontSize:9,letterSpacing:2,
  ...
  return(
    <div style={{maxWidth:680,margin:"100px auto",padding:"0 24px",textAlign:"center"}}>
      <h2 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",fontWeight:400,
        fontSize:"clamp(22px,4vw,38px)",color:"#bcbab6",marginBottom:20}}>{title}</h2>
      <div style={{width:36,height:1,background:"#dedad6",margin:"0 auto 20px"}}/>
      <p style={{color:"#7a7875",fontSize:12,letterSpacing:1,
        fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,marginBottom:10}}>{soon}</p>
      {contact&&<p style={{color:"#8a8a85",fontSize:11,
...
export default function App(){
  ...
  return(
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#f5f3f0",
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .nb{background:none;border:none;color:#5a5856;font-size:11px;letter-spacing:3px;
        ...
        .nb.gr{color:#bcbab6;cursor:default;pointer-events:none;}
        ...
        .bs:hover{opacity:.8;}
        .bg{background:none;border:1px solid #c8c4c0;color:#4a4846;padding:14px 30px;
          font-size:9px;letter-spacing:3px;text-transform:uppercase;cursor:pointer;
      ...
      {/* ══ AGE GATE ══════════════════════════════════════════════════════════ */}
      {!dis&&(
        <div style={{position:"fixed",inset:0,zIndex:9999,background:"#f5f3f0",
            ...
            {LANGS.map(l=>(
              <button key={l}
                style={{background:"none",border:lang===l?"1px solid #1a1a1a":"1px solid #dedad6",
                  color:lang===l?"#1a1a1a":"#8a8a85",padding:"3px 7px",fontSize:9,
                  cursor:"pointer",fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
          ...
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,fontSize:9,
            letterSpacing:3,color:"#7a7875",marginBottom:4,textTransform:"uppercase"}}>
            Sébastien Moreu & André Vaszkievicz · Paris 2024
          </p>
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,fontSize:8,
            letterSpacing:4,color:"#bcbab6",marginBottom:24,textTransform:"uppercase"}}>
            {t.aw}
          </p>
          ...
          <div style={{background:"#ffffff",border:"1px solid #dedad6",
            ...
            <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,fontSize:11,
              color:"#6b6967",lineHeight:1.8,marginBottom:16}}>{t.am}</p>
            ...
            <label style={{display:"flex",alignItems:"flex-start",gap:10,
              ...
              <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                fontSize:11,color:"#4a4846",lineHeight:1.6}}>{t.ck1}</span>
            </label>
            ...
            <label style={{display:"flex",alignItems:"flex-start",gap:10,cursor:"pointer"}}>
              <input type="checkbox" checked={ck2} onChange={e=>setCk2(e.target.checked)}
                style={{marginTop:2,width:16,height:16,accentColor:"#1a1a1a",
                  flexShrink:0,cursor:"pointer"}}/>
              <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                fontSize:11,color:"#4a4846",lineHeight:1.6}}>{t.ck2}</span>
            </label>
          </div>
          ...
          <div style={{marginTop:20,display:"flex",gap:16,fontSize:9,color:"#bcbab6",
            letterSpacing:1,fontFamily:"'Space Grotesk',sans-serif",fontWeight:300}}>
            <a href={`https://${t.si}`} style={{color:"#bcbab6",textDecoration:"none"}}>{t.si}</a>
            <span>·</span>
            <a href={`https://${t.pv}`} style={{color:"#bcbab6",textDecoration:"none"}}>{t.pv}</a>
          </div>
        </div>
      )}
      ...
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:800,
        background:"rgba(245,243,240,0.97)",backdropFilter:"blur(16px)",
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,flexShrink:0}}>
            ...
            <div style={{position:"relative"}}>
              <button onClick={()=>{setLangOpen(!langOpen);setMenuOpen(false);}}
                ...
                {lang} <span style={{fontSize:7,color:"#8a8a85"}}>▾</span>
              </button>
              {langOpen&&(
                <div style={{position:"absolute",top:"calc(100% + 4px)",right:0,
                  background:"#f5f3f0",border:"1px solid #dedad6",zIndex:900,
                  minWidth:52,boxShadow:"0 4px 20px rgba(0,0,0,0.08)"}}>
                  {LANGS.filter(l=>l!==lang).map(l=>(
                    <button key={l}
                      onClick={()=>{setLang(l);setLangOpen(false);}}
                      style={{display:"block",width:"100%",background:"none",border:"none",
                        borderBottom:"1px solid #eeece8",padding:"9px 0",fontSize:9,
                        letterSpacing:1,cursor:"pointer",fontFamily:"'Space Grotesk',sans-serif",
                        fontWeight:400,color:"#4a4846",textAlign:"center"}}>
                      {l}
                    </button>
                  ))}
                </div>
            ...
            <button onClick={()=>{if(!ageOk){setDis(false);}else{setAgeOk(false);}setLangOpen(false);}}
              style={{background:"none",
                ...
                color:ageOk?"#1a1a1a":"#8a8a85",padding:"5px 7px",fontSize:8,
                letterSpacing:1,cursor:"pointer",fontFamily:"'Space Grotesk',sans-serif",
            ...
            <button onClick={()=>{setMenuOpen(!menuOpen);setLangOpen(false);}}
              ...
              <span style={{display:"block",width:18,height:1.5,background:"#4a4846",
                transition:"all .25s",
                transform:menuOpen?"rotate(45deg) translate(4px,4px)":"none"}}/>
              <span style={{display:"block",width:18,height:1.5,
                background:menuOpen?"transparent":"#4a4846",transition:"all .25s"}}/>
              <span style={{display:"block",width:18,height:1.5,background:"#4a4846",
                transition:"all .25s",
                transform:menuOpen?"rotate(-45deg) translate(4px,-4px)":"none"}}/>
            </button>
      ...
      {menuOpen&&(
        <div style={{position:"fixed",inset:0,zIndex:790,
          background:"rgba(245,243,240,0.98)",backdropFilter:"blur(20px)",
      ...
      {sec==="portfolio"&&(<>
        <div style={{background:"#ffffff",textAlign:"center",
          ...
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,fontSize:8,
            letterSpacing:5,color:"#7a7875",marginBottom:12,textTransform:"uppercase"}}>
            {t.hl}
          </p>
          <h1 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",fontWeight:400,
            fontSize:"clamp(28px,6.5vw,72px)",lineHeight:1.15,color:"#1a1a1a",
            marginBottom:12,whiteSpace:"pre-line"}}>{t.ht}</h1>
          <p style={{color:"#4a4846",fontSize:13,letterSpacing:2,marginBottom:4,fontWeight:400}}>
            {t.hs}
          </p>
          <p style={{color:"#7a7875",fontSize:11,letterSpacing:1,marginBottom:20}}>{t.hy}</p>
          <p style={{color:"#6b6967",fontSize:13,lineHeight:1.9,whiteSpace:"pre-line",
        ...
        <div style={{maxWidth:860,margin:"0 auto",padding:"40px 14px 70px"}}>
          <div style={{display:"flex",alignItems:"baseline",gap:12,marginBottom:6}}>
            ...
            <span style={{color:"#8a8a85",fontSize:9,letterSpacing:3,
              fontFamily:"'Space Grotesk',sans-serif",fontWeight:300}}>— XI</span>
          </div>
          <p style={{color:"#6b6967",fontSize:12,lineHeight:1.9,whiteSpace:"pre-line",
          ...
          <div id="pg" style={{display:"flex",flexDirection:"column"}}>
            {PRINTS.map((p,idx)=>(
              <div key={p.id} className="hs"
                ...
                <div style={{flexShrink:0,width:"32%",maxWidth:200,background:"#f0eee9"}}>
                  <PImg src={p.src} ageOk={ageOk} bz={p.bz}/>
                </div>
                <div style={{flex:1,padding:"20px 18px",display:"flex",
                  flexDirection:"column",justifyContent:"center",gap:7}}>
                  <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                    fontSize:9,color:"#8a8a85",letterSpacing:4,textTransform:"uppercase"}}>
                    {p.num} / XI
                  </span>
                  ...
                  <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                    fontSize:10,color:"#7a7875"}}>{p.tech}</p>
                  <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                    fontSize:8,color:"#bcbab6",letterSpacing:2,textTransform:"uppercase"}}>
                    {t.mg}
                  </p>
                </div>
              </div>
        ...
        <div style={{maxWidth:960,margin:"60px auto",padding:"0 18px 70px"}}>
          <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:6}}>
            <button onClick={()=>goSec("portfolio")}
              style={{background:"none",border:"none",cursor:"pointer",color:"#8a8a85",
          ...
          <p style={{color:"#7a7875",fontSize:11,letterSpacing:1,
          ...
          <p style={{color:"#8a8a85",fontSize:8,letterSpacing:2,marginTop:8,
      ...
      {sec==="coffret"&&(
        <div style={{maxWidth:1140,margin:"60px auto",padding:"0 14px 70px"}}>
          <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:6}}>
            <button onClick={()=>goSec("portfolio")}
              style={{background:"none",border:"none",cursor:"pointer",
                color:"#8a8a85",fontSize:18,lineHeight:1,padding:"0 4px 0 0"}}>←</button>
            <h2 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
              fontWeight:400,fontSize:"clamp(20px,4vw,38px)"}}>{t.ct}</h2>
          </div>
          <div style={{color:"#6b6967",fontSize:12,letterSpacing:1,
          ...
          <div style={{background:"#ffffff",border:"1px solid #dedad6",marginBottom:24}}>
            ...
            <p style={{padding:"8px 14px",color:"#7a7875",fontSize:10,letterSpacing:1,
          ...
          <h3 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
            ...
            <span style={{fontFamily:"'Space Grotesk',sans-serif",fontStyle:"normal",
              fontSize:9,letterSpacing:3,color:"#8a8a85",marginLeft:14,
            ...
            {[{src:IMG.coffret_pf_print,cap:"Coffret PF fermé · Tirage I extrait"},
              ...
              <div key={i} style={{background:"#ffffff",border:"1px solid #dedad6"}}>
                <img src={im.src} alt="" draggable={false}
                  onContextMenu={e=>e.preventDefault()} style={{width:"100%",display:"block"}}/>
                <p style={{padding:"6px 10px",color:"#7a7875",fontSize:9,
      ...
      {sec==="chez"&&(
        <div style={{maxWidth:1140,margin:"60px auto",padding:"0 14px 70px"}}>
          ...
          <p style={{color:"#6b6967",fontSize:12,letterSpacing:1,
            fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,marginBottom:32}}>
            {t.zs}
          </p>
          <div style={{background:"#ffffff",border:"1px solid #dedad6",marginBottom:2}}>
            <img src={ageOk?IMG.inside:IMG.inside_blur} alt="" draggable={false}
              onContextMenu={e=>e.preventDefault()} style={{width:"100%",display:"block"}}/>
            <p style={{padding:"6px 12px",color:"#7a7875",fontSize:9,
              fontFamily:"'Space Grotesk',sans-serif",fontWeight:300}}>
      ...
      {sec==="shop"&&(
        <div style={{maxWidth:940,margin:"60px auto",padding:"0 18px 70px"}}>
            ...
            {EDS.map(e=>(
              <button key={e.key} onClick={()=>setEt(e.key)}
                style={{background:"none",border:"none",
                  ...
                  color:et===e.key?"#1a1a1a":"#8a8a85",padding:"9px 22px",fontSize:9,
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24,marginBottom:8,
            ...
            <div>
              <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,fontSize:8,
                letterSpacing:4,color:"#8a8a85",marginBottom:8,textTransform:"uppercase"}}>
                {et==="pf"?t.pft:t.gft}
              </p>
              <p style={{fontSize:13,fontWeight:400,color:"#4a4846",marginBottom:5}}>
                {et==="pf"?t.pfc:t.gfc}
              </p>
              <p style={{color:"#7a7875",fontSize:11,marginBottom:5,
                fontFamily:"'Space Grotesk',sans-serif",fontWeight:300}}>{t.sg}</p>
              <p style={{color:"#8a8a85",fontSize:9,
                fontFamily:"'Space Grotesk',sans-serif",fontWeight:300}}>
                {et==="pf"?t.pfi:t.gfi}
              </p>
            </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(210px,1fr))",
            ...
            {[{ti:t.sh,bo:t.sb},{ti:t.py,bo:t.pb},{ti:t.co,bo:t.cb}].map(c=>(
              <div key={c.ti} style={{background:"#ffffff",border:"1px solid #dedad6",
                ...
                <p style={{color:"#6b6967",fontSize:12,lineHeight:1.9,
      ...
      {sec==="bio"&&(
        <div style={{maxWidth:840,margin:"60px auto",padding:"0 18px 70px"}}>
          ...
          {/* Bios first */}
          {[{n:t.sn,b:t.sb2,i:"S.M."},{n:t.vn,b:t.vb,i:"A.V."}].map((a,i)=>(
            <div key={i} style={{display:"grid",gridTemplateColumns:"50px 1fr",gap:28,
              marginBottom:44,paddingBottom:44,
              borderBottom:i===0?"1px solid #dedad6":"none"}}>
              <div style={{textAlign:"center",paddingTop:3}}>
                <div style={{width:40,height:40,borderRadius:"50%",border:"1px solid #dedad6",
                  display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 6px"}}>
                  <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                    fontSize:8,color:"#8a8a85",letterSpacing:1}}>{a.i}</span>
                </div>
              </div>
              <div>
                <p style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
                  fontSize:21,fontWeight:400,marginBottom:12}}>{a.n}</p>
                <p style={{color:"#4a4846",fontSize:14,lineHeight:1.9,fontWeight:300}}>
                  {a.b}
                </p>
              </div>
            </div>
      ...
      <footer style={{borderTop:"1px solid #dedad6",
        ...
        background:"#f5f3f0",display:"flex",justifyContent:"space-between",
        alignItems:"center",flexWrap:"wrap",gap:10}}>
        <div style={{display:"flex",alignItems:"center",gap:7}}>
          <Logo sz={20}/>
          <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
            fontSize:8,letterSpacing:4,color:"#8a8a85"}}>A.V.S.M PRINTS</span>
        </div>
        <p style={{color:"#8a8a85",fontSize:8,whiteSpace:"pre-line",textAlign:"center",
          fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,letterSpacing:.3}}>
          {t.lg}
        </p>
        <a href={`https://${t.pv}`}
          style={{color:"#8a8a85",fontSize:8,letterSpacing:1,textDecoration:"none",
