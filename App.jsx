    ...
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#fafafa",
      ...
      {sec==="portfolio"&&(<>
        ...
        <div style={{maxWidth:860,margin:"0 auto",padding:"40px 14px 70px"}}>
          ...
          {/* ── Planche 0 : colophon recto-verso ─────────────────────────── */}
          <div style={{background:"#ffffff",border:"1px solid #cfcbc4",
            marginBottom:32,padding:"20px 18px"}}>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:14}}>
              <div onClick={()=>setPlanchePreview("recto")}
                ...
                <img src={IMG.planche_recto} alt="Recto"
                  style={{width:"100%",height:"auto",display:"block",background:"#fafafa"}}/>
                <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                  fontSize:9,letterSpacing:3,color:"#3a3836",textTransform:"uppercase"}}>Recto</span>
              </div>
              <div onClick={()=>setPlanchePreview("verso")}
                ...
                <img src={IMG.planche_verso} alt="Verso"
                  style={{width:"100%",height:"auto",display:"block",background:"#fafafa"}}/>
                <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                  fontSize:9,letterSpacing:3,color:"#3a3836",textTransform:"uppercase"}}>Verso</span>
              </div>
            </div>
            <p style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
              fontSize:"clamp(13px,1.9vw,18px)",fontWeight:400,color:"#1a1a1a",
              lineHeight:1.4,marginBottom:6,textAlign:"center"}}>
              I Love You Moneypenis
              <span style={{fontFamily:"'Space Grotesk',sans-serif",fontStyle:"normal",
                fontSize:"clamp(10px,1.5vw,13px)",fontWeight:300,
                color:"#3a3836",letterSpacing:3,marginLeft:10}}>· 0 ·</span>
            </p>
            <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
              fontSize:10,color:"#2a2826",textAlign:"center",lineHeight:1.7}}>{t.pl0}</p>
          </div>
