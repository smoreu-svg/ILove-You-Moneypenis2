      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @keyframes introBounce {
          ...
          /* — Première explosion : très gros — */
          13%  { transform: scale(10) rotate(220deg);           animation-timing-function: cubic-bezier(.85,0,.15,1); }
          /* — Rétrécissement brusque — */
          20%  { transform: scale(0.16) rotate(360deg);         animation-timing-function: ease-in; }
          /* — Deuxième explosion — */
          28%  { transform: scale(8.5) rotate(540deg);          animation-timing-function: cubic-bezier(.8,0,.2,1); }
          /* — Re-rétrécissement — */
          35%  { transform: scale(0.22) rotate(680deg);         animation-timing-function: cubic-bezier(.34,1.4,.64,1); }
          /* — Rebonds billard sur les 4 coins — */
          42%  { transform: translate(36vw, 22vh) scale(0.4) rotate(820deg);   animation-timing-function: cubic-bezier(.3,.9,.7,.1); }
          49%  { transform: translate(36vw, 54vh) scale(0.4) rotate(960deg);   animation-timing-function: cubic-bezier(.3,.9,.7,.1); }
          56%  { transform: translate(-36vw, 54vh) scale(0.45) rotate(1100deg); animation-timing-function: cubic-bezier(.3,.9,.7,.1); }
          63%  { transform: translate(-36vw, 22vh) scale(0.45) rotate(1240deg); animation-timing-function: cubic-bezier(.3,.9,.7,.1); }
          /* — Traversée en diagonale vers centre — */
          70%  { transform: translate(20vw, 36vh) scale(0.5) rotate(1380deg);  animation-timing-function: ease-in; }
          75%  { transform: translate(0, 28vh) scale(0.55) rotate(1500deg);    animation-timing-function: cubic-bezier(.9,0,.1,1); }
          /* — Troisième et dernière explosion : énorme — */
          81%  { transform: scale(12) rotate(1720deg);          animation-timing-function: cubic-bezier(.7,0,.3,1); }
          /* — Pulvérisation puis rebond ressort — */
          87%  { transform: scale(0.12) rotate(1860deg);        animation-timing-function: cubic-bezier(.34,1.6,.64,1); }
          94%  { transform: scale(1.35) rotate(2040deg);        animation-timing-function: cubic-bezier(.34,1.2,.64,1); }
          /* — Atterrissage final, à l'endroit — */
