      ...
      {menuOpen&&(
        <div style={{position:"fixed",inset:0,zIndex:790,
          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",
            ...
            {/* Display order: bio, portfolio (gros), coffret, insitu, video, shop, contact, jeu (aubergine) */}
            {[5,0,2,3,1,4,7,6].map((i)=>{
              const n=t.nav[i];
              const sk=NAV[i];
              ...
              return (
                <button key={sk}
                  ...
                  onClick={()=>{if(!GR.includes(sk))goSec(sk);}}>
                  {n}
                </button>
              );
            })}
                ...
                <div style={{display:"grid",
                  ...
                  <div onClick={()=>setShopView("pf")}
                    ...
                    <p style={{color:"#0a1228",fontSize:10,opacity:.7,marginBottom:4,
                      fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
                      {(t.availPort||"Numéros %F% à %T% sur %N%").replace("%F%",EDS[0].avail.portFrom).replace("%T%",EDS[0].avail.portTo).replace("%N%",EDS[0].avail.portTot)}
                    </p>
                  ...
                  <div onClick={()=>setShopView("gf")}
                    ...
                    <p style={{color:"#0a1228",fontSize:10,opacity:.7,marginBottom:4,
                      fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
                      {(t.availPort||"Numéros %F% à %T% sur %N%").replace("%F%",EDS[1].avail.portFrom).replace("%T%",EDS[1].avail.portTo).replace("%N%",EDS[1].avail.portTot)}
                    </p>
                    <p style={{color:"#0a1228",fontSize:10,opacity:.7,
                      fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
                      {t.gfi}
