          ...
          <div style={{position:"relative",width:"100%",height:"100%"}}>
            {(() => {
              const items=[
                ...
                {sk:"install",    side:"left",  pos:10, top:38, size:"sml",  fsOver:"clamp(13px,2vw,18px)",    maxW:"50vw", label: t.appT||"La Belle et L'Appli"},
