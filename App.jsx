    ...
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#fafafa",
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @keyframes introBounce {
          ...
          5%   { transform: scale(0.4) rotate(25deg);                                 animation-timing-function: cubic-bezier(.7,0,.4,1); }

          /* — II. 1ʳᵉ explosion : centrée, déborde sur les 4 bords — */
          13%  { transform: scale(11) rotate(220deg);                                 animation-timing-function: cubic-bezier(.85,0,.15,1); }
          /* Rétrécissement éclair */
          20%  { transform: scale(0.14) rotate(380deg);                               animation-timing-function: ease-in; }

          /* — III. 2ᵉ explosion : déborde vers le coin haut-droit — */
          28%  { transform: translate(24vw, -22vh) scale(9) rotate(560deg);           animation-timing-function: cubic-bezier(.8,0,.2,1); }
          /* Rebond ressort dans cette zone */
          34%  { transform: translate(20vw, -18vh) scale(0.2) rotate(700deg);         animation-timing-function: cubic-bezier(.34,1.4,.64,1); }

          /* — IV. Billard · 5 segments tous diagonaux — */
          /* Coin NO → bord E (haut) */
          41%  { transform: translate(-32vw, -25vh) scale(0.4) rotate(840deg);        animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          /* E haut → SE bas (diagonale longue) */
          49%  { transform: translate(32vw, 5vh) scale(0.42) rotate(990deg);          animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          /* SE bas → bord W (haut) */
          56%  { transform: translate(-12vw, 25vh) scale(0.45) rotate(1140deg);       animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          /* W haut → bord N (droite) */
          63%  { transform: translate(-32vw, -5vh) scale(0.45) rotate(1290deg);       animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          /* N droite → quasi-centre */
          70%  { transform: translate(12vw, -25vh) scale(0.5) rotate(1440deg);        animation-timing-function: cubic-bezier(.3,.55,.7,.45); }
          /* Convergence vers centre */
          76%  { transform: translate(0, 0) scale(0.55) rotate(1560deg);              animation-timing-function: cubic-bezier(.9,0,.1,1); }

          /* — V. 3ᵉ explosion : énorme, déborde vers le coin bas-gauche — */
          82%  { transform: translate(-26vw, 22vh) scale(12.5) rotate(1740deg);       animation-timing-function: cubic-bezier(.7,0,.3,1); }
          /* Pulvérisation au centre */
          88%  { transform: scale(0.12) rotate(1900deg);                              animation-timing-function: cubic-bezier(.34,1.6,.64,1); }
          /* Rebond ressort & overshoot */
      ...
      {!dis&&(
        <div style={{position:"fixed",inset:0,zIndex:9999,background:"#ffffff",
          ...
          {/* Declaration box · plus compacte */}
          <div style={{background:"#ffffff",border:"1px solid #cfcbc4",
            padding:"14px 16px",maxWidth:380,width:"100%",marginBottom:18,textAlign:"left"}}>
            <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:10.5,
              color:"#1a1a1a",lineHeight:1.7,marginBottom:12}}>{t.am}</p>
            ...
            <label style={{display:"flex",alignItems:"flex-start",gap:9,
              ...
              <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:10.5,color:"#1a1a1a",lineHeight:1.5}}>{t.ck1}</span>
            </label>
            ...
            <label style={{display:"flex",alignItems:"flex-start",gap:9,cursor:"pointer"}}>
              <input type="checkbox" checked={ck2} onChange={e=>setCk2(e.target.checked)}
                style={{marginTop:2,width:14,height:14,accentColor:"#1a1a1a",
                  flexShrink:0,cursor:"pointer"}}/>
              <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:10.5,color:"#1a1a1a",lineHeight:1.5}}>{t.ck2}</span>
            </label>
          </div>
          ...
          <div style={{marginTop:20,display:"flex",gap:16,fontSize:10,color:"#1a1a1a",
            ...
            <div style={{flex:"0 0 auto",width:"40%",display:"grid",
              ...
              <div onClick={()=>setPlanchePreview("recto")}
                ...
                <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                  fontSize:8,letterSpacing:3,color:"#3a3836",textTransform:"uppercase"}}>Recto</span>
              </div>
              <div onClick={()=>setPlanchePreview("verso")}
                ...
                <img src={IMG.planche_verso} alt="Verso"
                  style={{width:"100%",height:"auto",display:"block"}}/>
                <span style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                  fontSize:8,letterSpacing:3,color:"#3a3836",textTransform:"uppercase"}}>Verso</span>
              </div>
            </div>
            ...
            <div style={{flex:1,padding:"20px 18px",display:"flex",
              ...
              <p style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
                ...
                <span style={{fontFamily:"'Space Grotesk',sans-serif",fontStyle:"normal",
                  ...
                  color:"#3a3836",letterSpacing:3,marginLeft:10}}>· 0</span>
              </p>
              <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                fontSize:10,color:"#2a2826"}}>{t.op} · Recto-verso</p>
              <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:300,
                fontSize:9,color:"#2a2826",lineHeight:1.6}}>{t.pl0}</p>
            </div>
          </div>
