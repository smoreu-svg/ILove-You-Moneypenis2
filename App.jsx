...
const PRINTS=[
  {id:1,num:"I",   src:"/tirage-01.jpg",tech:"Poème · Croix dorée",                                origLangs:["FR","PT","EN"],bz:[{t:42,l:52,w:34,h:30,lb:"— Je suis Moneypenis —"}],landscape:true},
  ...
  {id:3,num:"III", src:"/tirage-03.jpg",tech:"Photographie couleur · Texte jaune",                 origLangs:["FR","PT","EN"],bz:[{t:2,l:8,w:84,h:52,lb:"— j'ai tant voyagé —"}],landscape:true},
  ...
  {id:5,num:"V",   src:"/tirage-05.jpg",tech:"Photo couleur · Texte rouge · Cravate Hermès",       origLangs:["FR","PT","EN"],bz:[{t:10,l:30,w:50,h:40,lb:"— je déguise mes désirs —"}],landscape:true},
  {id:6,num:"VI",  src:"/tirage-06.jpg",tech:"Photographie couleur · Jean ouvert · Nature",        origLangs:["FR"],          bz:[{t:15,l:28,w:44,h:38,lb:"— open air —"}],landscape:true},
  {id:7,num:"VII", src:"/tirage-07.jpg",tech:"Photo teintée cyan · Lettre manuscrite orange",      origLangs:["FR","EN"],     bz:[{t:18,l:28,w:56,h:75,lb:""}],landscape:true},
  ...
  {id:10,num:"X",  src:"/tirage-10.jpg",tech:"Texte rouge · NB · Manifeste",                       origLangs:["FR","PT","EN"],bz:[{t:20,l:38,w:48,h:45,lb:"— je suis moneypenis —"}],landscape:true},
...
// ── PRÉVENTION & URGENCE — Annuaire v1 (FR+EN, 8 pays) ────────────────────────
// Données vérifiées mai 2026. Sources institutionnelles + asso historiques.
// Hiérarchie : urgences (suicide, mineurs) en tête, puis catégories de soutien.
...
const PREV_DATA = {
  FR:[
    {code:"FR",flag:"🇫🇷",name:"France",cats:{
      suicide:[{n:"3114 — Numéro national de prévention du suicide",u:"https://3114.fr",t:"3114",d:"Ligne officielle Ministère de la Santé, professionnels formés.",h:"24/7"}],
      minors:[
        {n:"119 — Allô Enfance en Danger",u:"https://www.allo119.gouv.fr",t:"119",d:"Service public national de signalement et d'écoute.",h:"24/7"},
        {n:"France Terre d'Asile — Mineurs Isolés Étrangers",u:"https://www.france-terre-asile.org",t:"+33 1 53 04 39 99",d:"Accompagnement juridique et social des MNA.",h:"Bureau lun–ven"},
        {n:"GISTI — Conseil juridique étrangers",u:"https://www.gisti.org",t:"+33 1 43 14 84 84",d:"Permanence droit des étrangers, défense MNA.",h:"Selon planning"},
        {n:"Croix-Rouge française",u:"https://www.croix-rouge.fr",t:"115 / 0 800 858 858",d:"Hébergement d'urgence et programmes mineurs isolés.",h:"24/7"}
      ],
      health:[
        {n:"Sida Info Service",u:"https://www.sida-info-service.org",t:"0 800 840 800",d:"Ligne nationale VIH/IST/sexualités, anonyme.",h:"24/7"},
        {n:"CeGIDD — Centres dépistage gratuit",u:"https://www.sante.fr",t:"Annuaire sante.fr",d:"Dépistage VIH/IST/hépatites gratuit anonyme + TPE.",h:"Variables"},
        {n:"AIDES",u:"https://www.aides.org",t:"+33 1 77 93 97 97",d:"Asso VIH/IST historique, dépistage TROD, info PrEP/TPE.",h:"Variables"}
      ],
      sw:[
        {n:"STRASS — Syndicat du Travail Sexuel",u:"https://strass-syndicat.org",t:"Via antennes",d:"Syndicat pro-droits par et pour les TDS.",h:"Permanences"},
        {n:"Médecins du Monde — Programme TDS",u:"https://www.medecinsdumonde.org",t:"+33 1 44 92 15 15",d:"Accès aux soins, dépistage, RDR sans condition.",h:"Selon mission"},
        {n:"Mouvement du Nid",u:"https://mouvementdunid.org",t:"+33 1 42 70 92 40",d:"Accompagnement inconditionnel non-criminalisant.",h:"Variables"}
      ],
      addict:[
        {n:"Drogues Info Service",u:"https://www.drogues-info-service.fr",t:"0 800 23 13 13",d:"Ligne nationale toutes substances, anonyme.",h:"8h–2h 7j/7"},
        {n:"AIDES — Programme Chemsex",u:"https://www.aides.org/chemsex",t:"Antennes locales",d:"RDR chemsex, groupes de parole, soutien HSH.",h:"Variables"},
        {n:"Le 190 — Santé sexuelle (Paris)",u:"https://www.le190.fr",t:"+33 1 55 25 32 72",d:"Centre santé sexuelle et chemsex, PrEP, addicto.",h:"Lun–sam sur RDV"}
      ],
      psy:[
    ...
    {code:"BE",flag:"🇧🇪",name:"Belgique",cats:{
      suicide:[{n:"Centre de Prévention du Suicide",u:"https://www.preventionsuicide.be",t:"0800 32 123",d:"Ligne historique de prévention en FWB.",h:"24/7"}],
      minors:[
        {n:"Child Focus",u:"https://www.childfocus.be",t:"116 000",d:"Enfants disparus et exploités, suivi MENA.",h:"24/7"},
        {n:"103 — Écoute-Enfants",u:"https://www.103ecoute.be",t:"103",d:"Écoute pour enfants et adolescents en difficulté.",h:"10h–24h"},
        {n:"Croix-Rouge Belgique — MENA",u:"https://www.croix-rouge.be",t:"+32 2 371 31 11",d:"Centres d'accueil mineurs étrangers non accompagnés.",h:"Bureau"}
      ],
      health:[
        {n:"Plate-Forme Prévention Sida",u:"https://www.preventionsida.org",t:"+32 2 733 72 99",d:"Information VIH/IST, orientation dépistage.",h:"Bureau"},
        {n:"Ex Æquo — Santé HSH",u:"https://www.exaequo.be",t:"+32 2 736 28 61",d:"Asso HSH : dépistage rapide, PrEP, chemsex.",h:"Permanences"},
        {n:"Centres de Référence SIDA",u:"https://www.aids-ref.be",t:"Selon hôpital",d:"Suivi VIH, PrEP, TPE (à débuter <48h).",h:"Hospitaliers"}
      ],
      sw:[
        {n:"UTSOPI — Union TDS Organisé·e·s",u:"https://www.utsopi.be",t:"+32 2 219 98 74",d:"Org pro-droits par et pour les TDS.",h:"Permanences"},
        {n:"Espace P…",u:"https://www.espacep.be",t:"+32 2 219 98 74",d:"Accompagnement social, santé et juridique inconditionnel.",h:"Variables"}
      ],
      addict:[
        {n:"Infor-Drogues",u:"https://www.infordrogues.be",t:"02 227 52 52",d:"Information et écoute sur toutes drogues, anonyme.",h:"Lun–ven 8h–20h"},
        {n:"Ex Æquo — Programme Chemsex",u:"https://www.exaequo.be/chemsex",t:"+32 2 736 28 61",d:"Accompagnement chemsex HSH, ateliers.",h:"Selon permanences"}
      ],
      psy:[
        {n:"Télé-Accueil Bruxelles",u:"https://www.tele-accueil.be",t:"107",d:"Écoute généraliste anonyme.",h:"24/7"},
        {n:"Tels Quels (Bruxelles)",u:"https://www.telsquels.be",t:"+32 2 512 45 87",d:"Accueil et soutien LGBTQI+, écoute.",h:"Permanences"},
        {n:"Alliàge (Liège)",u:"https://www.alliage.be",t:"+32 4 223 65 89",d:"Soutien LGBTQI+, groupes de parole.",h:"Permanences"}
      ]
    }},
    {code:"CH",flag:"🇨🇭",name:"Suisse",cats:{
      suicide:[{n:"La Main Tendue",u:"https://www.143.ch",t:"143",d:"Ligne nationale d'écoute et de crise, anonyme.",h:"24/7"}],
      minors:[
        {n:"Pro Juventute — 147",u:"https://www.147.ch",t:"147",d:"Ligne professionnelle enfants/ados en crise.",h:"24/7"},
        {n:"SSI Suisse — MNA",u:"https://www.ssiss.ch",t:"+41 22 731 67 00",d:"Accompagnement mineurs non accompagnés.",h:"Bureau"},
        {n:"Croix-Rouge Suisse — MNA",u:"https://www.redcross.ch",t:"+41 58 400 41 11",d:"Mentorat et accompagnement requérants mineurs.",h:"Bureau"}
      ],
      health:[
        {n:"Aide Suisse contre le Sida",u:"https://www.aids.ch/fr",t:"+41 44 447 11 11",d:"Faîtière VIH ; info, dépistage, PrEP, Checkpoints.",h:"Bureau"},
        {n:"Checkpoint (GE/VD/ZH/BE/BS/TI)",u:"https://www.mycheckpoint.ch",t:"GE +41 22 906 40 30",d:"Centres santé sexuelle communautaires HSH/trans.",h:"RDV + walk-in"},
        {n:"SANTÉ SEXUELLE Suisse",u:"https://www.sante-sexuelle.ch",t:"Centres cantonaux",d:"Faîtière planning et santé sexuelle.",h:"Variables"}
      ],
      sw:[
        {n:"ProCoRé — Réseau TDS",u:"https://www.prokore.ch",t:"Via membres",d:"Réseau national pro-droits TDS.",h:"Bureau"},
        {n:"Aspasie (Genève)",u:"https://www.aspasie.ch",t:"+41 22 732 68 28",d:"Soutien historique TDS : santé, droits, médiation.",h:"Lun–ven"},
        {n:"Fleur de Pavé (Lausanne)",u:"https://www.fleurdepave.ch",t:"+41 21 661 10 80",d:"Accueil et accompagnement TDS canton Vaud.",h:"Permanences"}
      ],
      addict:[
        {n:"Safe Zone — Conseil en ligne",u:"https://www.safezone.ch",t:"Chat anonyme",d:"Conseil professionnel sur addictions.",h:"Chat planifié"},
        {n:"Checkpoint — Consultation chemsex",u:"https://www.mycheckpoint.ch",t:"Selon ville",d:"Consultations chemsex HSH, RDR.",h:"Sur RDV"}
      ],
      psy:[
        {n:"La Main Tendue (143)",u:"https://www.143.ch",t:"143",d:"Écoute généraliste également.",h:"24/7"},
        {n:"Dialogai (Genève)",u:"https://www.dialogai.org",t:"+41 22 906 40 40",d:"Asso gay : écoute, soutien, dépistage, plaidoyer.",h:"Bureau"},
        {n:"VoGay (Lausanne)",u:"https://www.vogay.ch",t:"+41 21 511 64 10",d:"Accueil, conseil, accompagnement LGBTIQ+.",h:"Bureau"}
      ]
    }},
    {code:"QC",flag:"🇨🇦",name:"Québec",cats:{
      suicide:[{n:"1 866 APPELLE — Prévention du suicide",u:"https://suicide.ca",t:"1 866 277-3553 · SMS 535353",d:"Ligne québécoise unique opérée par l'AQPS.",h:"24/7"}],
      minors:[
        {n:"DPJ — Protection de la jeunesse",u:"https://www.quebec.ca/famille-et-soutien-aux-personnes/enfance/protection-jeunesse",t:"Numéros régionaux",d:"Signalement officiel d'un enfant en danger.",h:"24/7"},
        {n:"Jeunesse, J'écoute",u:"https://jeunessejecoute.ca",t:"1 800 668-6868 · texto CONNECT au 686868",d:"Soutien santé mentale jeunes, pancanadien multilingue.",h:"24/7"},
        {n:"PRAIDA — Demandeurs d'asile",u:"https://ciusss-centreouestmtl.gouv.qc.ca/praida",t:"+1 514 731-8531",d:"Accompagnement médical et juridique, incl. MNA.",h:"Bureau"}
      ],
      health:[
        {n:"Info-Santé / Info-Social",u:"https://www.quebec.ca/sante/conseils-et-prevention/info-sante-811",t:"811",d:"Info santé publique, orientation ITSS/dépistage.",h:"24/7"},
        {n:"RÉZO — Santé HSH",u:"https://www.rezosante.org",t:"+1 514 521-7778",d:"Org HSH/trans : dépistage rapide, PrEP, TDS, chemsex.",h:"Bureau"},
        {n:"Clinique L'Actuel",u:"https://cliniquelactuel.com",t:"+1 514 524-1001",d:"Centre médical VIH/IST/PrEP/TPE gay/bi/trans.",h:"Sur RDV"}
      ],
      sw:[
        {n:"Stella, l'amie de Maimie",u:"https://chezstella.org",t:"+1 514 285-8889",d:"Par et pour les TDS : info, clinique, mauvais clients.",h:"Lun-ven 11-17h"},
        {n:"RÉZO — Travailleurs du sexe",u:"https://www.rezosante.org/travail-du-sexe",t:"+1 514 521-7778",d:"Soutien hommes cis/trans TDS.",h:"Permanences"}
      ],
      addict:[
        {n:"Drogue : aide et référence",u:"https://www.aidedrogue.ca",t:"1 800 265-2626",d:"Ligne provinciale, info et orientation.",h:"24/7"},
        {n:"RÉZO — Programme PROFIL",u:"https://www.rezosante.org",t:"+1 514 521-7778",d:"Soutien pair-aidant chemsex.",h:"Permanences"}
      ],
      psy:[
        {n:"Tel-Aide",u:"https://www.telaide.org",t:"+1 514 935-1101",d:"Écoute généraliste anonyme.",h:"24/7"},
        {n:"Interligne",u:"https://interligne.co",t:"1 888 505-1010",d:"Centre LGBTQ+ première ligne, écoute, intervention.",h:"24/7"},
        {n:"ATQ — Aide aux Trans Québec",u:"https://atq1980.org",t:"1 855 909-9038",d:"Soutien par pairs personnes trans et non-binaires.",h:"9-21h 7j/7"}
      ]
    }}
  ],
  EN:[
    {code:"UK",flag:"🇬🇧",name:"United Kingdom",cats:{
      suicide:[
        {n:"Samaritans",u:"https://www.samaritans.org",t:"116 123",d:"Historic national emotional support line.",h:"24/7"},
        {n:"Shout",u:"https://giveusashout.org",t:"Text SHOUT to 85258",d:"National text-based crisis support service.",h:"24/7"}
      ],
      minors:[
        {n:"Childline (NSPCC)",u:"https://www.childline.org.uk",t:"0800 1111",d:"National helpline for under-19s, any concern.",h:"24/7"},
        {n:"NSPCC Helpline",u:"https://www.nspcc.org.uk",t:"0808 800 5000",d:"For adults worried about a child's safety.",h:"Mon–Fri 8–22h"},
        {n:"Refugee Council — Children",u:"https://www.refugeecouncil.org.uk",t:"+44 20 7346 6700",d:"Advice for unaccompanied asylum-seeking children.",h:"Business hours"},
        {n:"ECPAT UK",u:"https://www.ecpat.org.uk",t:"+44 20 7607 2136",d:"Against child trafficking and exploitation.",h:"Business hours"},
        {n:"Missing People (116 000)",u:"https://www.missingpeople.org.uk",t:"116 000",d:"EU-wide missing children hotline.",h:"24/7"}
      ],
      health:[
        {n:"National Sexual Health Helpline",u:"https://www.nhs.uk/live-well/sexual-health",t:"0300 123 7123",d:"NHS advice on contraception, STIs.",h:"Mon–Fri 9–20h"},
        {n:"THT Direct",u:"https://www.tht.org.uk",t:"0808 802 1221",d:"UK's leading HIV charity: testing, PrEP, PEP.",h:"Mon–Fri 10–16h"},
        {n:"56 Dean Street (NHS)",u:"https://www.dean.st",t:"+44 20 3315 9555",d:"Europe's largest sexual health clinic, chemsex care.",h:"Mon–Sat"},
        {n:"NHS sexual health clinic finder",u:"https://www.nhs.uk/service-search/sexual-health",t:"Postcode search",d:"Free, confidential STI/HIV testing and PrEP.",h:"Varies"}
      ],
      sw:[
        {n:"English Collective of Prostitutes",u:"https://prostitutescollective.net",t:"+44 20 7482 2496",d:"Self-organised SW group, decriminalisation.",h:"Drop-in T/W/Th"},
        {n:"National Ugly Mugs",u:"https://nationaluglymugs.org",t:"+44 161 629 9861",d:"Safety service: alerts on dangerous individuals.",h:"Online 24/7"},
        {n:"SWARM Collective",u:"https://www.swarmcollective.org",t:"Email/form",d:"Pro-rights sex worker-led collective, mutual aid.",h:"N/A"}
      ],
      addict:[
        {n:"FRANK",u:"https://www.talktofrank.com",t:"0300 123 6600 · text 82111",d:"Government drugs info line, non-judgmental.",h:"24/7"},
        {n:"56 Dean Street — Chemsex Service",u:"https://www.dean.st/chems",t:"+44 20 3315 9555",d:"World's first targeted chemsex support.",h:"Clinic hours"},
        {n:"London Friend — Antidote",u:"https://londonfriend.org.uk/antidote",t:"+44 20 7833 1674",d:"UK's only LGBTQ-specific drug & alcohol service.",h:"Office hours"}
      ],
      psy:[
        {n:"Switchboard LGBT+",u:"https://switchboard.lgbt",t:"0800 0119 100",d:"National LGBTQIA+ support line.",h:"10–22h"},
        {n:"Mind Infoline",u:"https://www.mind.org.uk",t:"0300 123 3393",d:"Mental health charity helpline.",h:"Mon–Fri 9–18h"},
        {n:"MindOut",u:"https://www.mindout.org.uk",t:"Online chat",d:"Mental health service by and for LGBTQ people.",h:"Scheduled"}
      ]
    }},
    {code:"US",flag:"🇺🇸",name:"United States",cats:{
      suicide:[
        {n:"988 Suicide & Crisis Lifeline",u:"https://988lifeline.org",t:"988",d:"National suicide and mental-health crisis line.",h:"24/7"},
        {n:"Crisis Text Line",u:"https://www.crisistextline.org",t:"Text HOME to 741741",d:"Text-based crisis counseling.",h:"24/7"}
      ],
      minors:[
        {n:"Childhelp Hotline",u:"https://www.childhelphotline.org",t:"1-800-422-4453",d:"National child abuse reporting and support.",h:"24/7"},
        {n:"National Human Trafficking Hotline",u:"https://humantraffickinghotline.org",t:"1-888-373-7888 · text 233733",d:"Report trafficking, services for victims incl. minors.",h:"24/7"},
        {n:"ORR — Unaccompanied Children",u:"https://www.acf.hhs.gov/orr/programs/uc",t:"1-800-203-7001",d:"Federal program for unaccompanied migrant children.",h:"24/7"},
        {n:"KIND — Kids in Need of Defense",u:"https://supportkind.org",t:"+1 202-824-8680",d:"Pro bono legal rep for immigrant children.",h:"Business hours"},
        {n:"NCMEC — Missing & Exploited Children",u:"https://www.missingkids.org",t:"1-800-843-5678",d:"Missing children reports, CyberTipline.",h:"24/7"}
      ],
      health:[
        {n:"CDC-INFO",u:"https://www.cdc.gov/cdc-info",t:"1-800-232-4636",d:"CDC national health info line, EN/ES.",h:"Mon–Fri 8–20h ET"},
        {n:"Planned Parenthood",u:"https://www.plannedparenthood.org",t:"1-800-230-7526",d:"Sexual & reproductive health, ≈600 centers.",h:"Varies"},
        {n:"GMHC",u:"https://www.gmhc.org",t:"1-800-243-7692",d:"Pioneering HIV/AIDS service org, NYC + national.",h:"Business hours"},
        {n:"PrEP Locator",u:"https://preplocator.org",t:"Online",d:"National database to find PrEP/PEP providers.",h:"24/7"}
      ],
      sw:[
        {n:"SWOP USA",u:"https://swopusa.org",t:"Chapter-based",d:"National pro-rights sex worker-led organization.",h:"Varies"},
        {n:"SWOP Behind Bars",u:"https://swopbehindbars.org",t:"+1 678-783-2244",d:"Support for incarcerated sex workers.",h:"Business hours"},
        {n:"St. James Infirmary (SF)",u:"https://stjamesinfirmary.org",t:"+1 415-554-8494",d:"Peer-based clinic for sex workers.",h:"Clinic hours"}
      ],
      addict:[
        {n:"SAMHSA National Helpline",u:"https://www.samhsa.gov/find-help/national-helpline",t:"1-800-662-4357",d:"Federal treatment referral, substance use + MH.",h:"24/7"},
        {n:"Crystal Meth Anonymous",u:"https://www.crystalmeth.org",t:"Meetings online",d:"12-step recovery from crystal meth.",h:"Daily"},
        {n:"Sex Addicts Anonymous",u:"https://saa-recovery.org",t:"1-800-477-8191",d:"12-step program for compulsive sexual behaviors.",h:"24/7 voicemail"}
      ],
      psy:[
    ...
    {code:"CA",flag:"🇨🇦",name:"Canada (English)",cats:{
      suicide:[
        {n:"9-8-8 Suicide Crisis Helpline",u:"https://988.ca",t:"9-8-8",d:"National suicide crisis helpline, bilingual.",h:"24/7"},
        {n:"Hope for Wellness (Indigenous)",u:"https://www.hopeforwellness.ca",t:"1-855-242-3310",d:"Culturally competent for First Nations, Inuit, Métis.",h:"24/7"}
      ],
      minors:[
        {n:"Kids Help Phone",u:"https://kidshelpphone.ca",t:"1-800-668-6868 · text 686868",d:"Only national 24/7 youth mental health service.",h:"24/7"},
        {n:"Provincial Child Protection",u:"https://www.canada.ca/en/public-health/services/child-abuse.html",t:"ON 1-800-461-2222 · BC 1-800-663-9122",d:"Mandatory child abuse reporting by province.",h:"24/7"},
        {n:"Canadian Council for Refugees",u:"https://ccrweb.ca",t:"+1 514 277-7223",d:"Advocacy and resources for refugee youth.",h:"Business hours"},
        {n:"Matthew House",u:"https://matthewhouse.ca",t:"Toronto +1 416-364-9803",d:"Refugee reception houses, settlement support.",h:"Shelter 24/7"}
      ],
      health:[
        {n:"CATIE",u:"https://www.catie.ca",t:"1-800-263-1638",d:"Canada's source for HIV and hep C info, bilingual.",h:"M–F 9–17h ET"},
        {n:"Sex Sense (BC) / SIECCAN",u:"https://www.optbc.org/sexsense",t:"1-800-739-7367",d:"Confidential sexual health info line.",h:"M–F 9–21h PT"},
        {n:"Hassle Free Clinic (Toronto)",u:"https://www.hasslefreeclinic.org",t:"+1 416-922-0566",d:"Free STI/HIV testing, PrEP, PEP, queer-affirming.",h:"Walk-in/RDV"}
      ],
      sw:[
        {n:"Maggie's Toronto",u:"https://www.maggiestoronto.ca",t:"+1 416-964-0150",d:"By and for sex workers: harm reduction, advocacy.",h:"Drop-in"},
        {n:"Canadian Alliance for SW Law Reform",u:"https://sexworklawreform.com",t:"Email",d:"National coalition of 25+ SW rights groups.",h:"N/A"},
        {n:"PEERS Victoria",u:"https://www.peersvictoria.org",t:"+1 250-388-5325",d:"Sex worker–run support services in Victoria.",h:"Business hours"}
      ],
      addict:[
        {n:"Wellness Together Canada",u:"https://www.wellnesstogether.ca",t:"Adults 1-866-585-0445 · Youth 1-888-668-6810",d:"Federal MH & substance use portal + crisis.",h:"24/7"},
        {n:"ConnexOntario",u:"https://www.connexontario.ca",t:"1-866-531-2600",d:"Info & referral mental health, addictions, gambling.",h:"24/7"},
        {n:"Crystal Meth Anonymous Canada",u:"https://crystalmeth.org/cma-meetings/canada",t:"Meetings",d:"12-step recovery from crystal meth.",h:"Daily"}
      ],
      psy:[
        {n:"LGBT YouthLine",u:"https://www.youthline.ca",t:"1-800-268-9688 · text 647-694-4275",d:"Peer support LGBTQ2S+ youth up to 29.",h:"Sun–Fri 16–21:30 ET"},
        {n:"Égale Canada",u:"https://egale.ca",t:"+1 416-964-7887",d:"National 2SLGBTQI advocacy, resources, referrals.",h:"Business hours"},
        {n:"Trans Lifeline Canada",u:"https://translifeline.org",t:"1-877-330-6366",d:"Peer support hotline by and for trans people.",h:"Varies"}
      ]
    }},
    {code:"AU",flag:"🇦🇺",name:"Australia",cats:{
      suicide:[
        {n:"Lifeline Australia",u:"https://www.lifeline.org.au",t:"13 11 14 · text 0477 13 11 14",d:"National crisis support since 1963.",h:"24/7"},
        {n:"Suicide Call Back Service",u:"https://www.suicidecallbackservice.org.au",t:"1300 659 467",d:"Free professional counselling.",h:"24/7"},
        {n:"13YARN",u:"https://www.13yarn.org.au",t:"13 92 76",d:"Crisis support by Aboriginal & TSI Crisis Supporters.",h:"24/7"}
      ],
      minors:[
        {n:"Kids Helpline",u:"https://kidshelpline.com.au",t:"1800 55 1800",d:"Phone & online counselling 5–25 yo.",h:"24/7"},
        {n:"Bravehearts",u:"https://bravehearts.org.au",t:"1800 272 831",d:"Child sexual abuse prevention & support.",h:"M–F 8:30–16:30"},
        {n:"Refugee Council of Australia",u:"https://www.refugeecouncil.org.au",t:"+61 2 9211 9333",d:"National umbrella body, MNA referrals.",h:"Business hours"},
        {n:"ASRC",u:"https://www.asrc.org.au",t:"+61 3 9326 6066",d:"Legal, health, casework for asylum seekers.",h:"Business hours"}
      ],
      health:[
        {n:"Healthdirect / SHIL NSW",u:"https://www.healthdirect.gov.au",t:"1800 022 222 · SHIL 1800 451 624",d:"Confidential sexual health advice and referrals.",h:"24/7 / M–F"},
        {n:"ACON",u:"https://www.acon.org.au",t:"+61 2 9206 2000 · 1800 063 060",d:"Largest LGBTQ+ health org: HIV, PrEP, chemsex.",h:"Business hours"},
        {n:"Thorne Harbour Health",u:"https://thorneharbour.org",t:"+61 3 9865 6700",d:"LGBTQ+ community health VIC, SA, Re-Wired chemsex.",h:"Business hours"}
      ],
      sw:[
        {n:"Scarlet Alliance",u:"https://scarletalliance.org.au",t:"+61 2 9517 2577",d:"National peer-led SW org, migrant SW support.",h:"Business hours"},
        {n:"SWOP NSW",u:"https://swop.org.au",t:"+61 2 9184 1900",d:"Peer health promotion and support, multilingual.",h:"Business hours"},
        {n:"Vixen Collective (VIC)",u:"https://vixencollective.com.au",t:"Website",d:"Victoria's peer-only SW org, mutual aid fund.",h:"N/A"}
      ],
      addict:[
        {n:"National AOD Hotline",u:"https://www.health.gov.au",t:"1800 250 015",d:"Connects to state/territory AOD service.",h:"24/7"},
        {n:"ACON / Thorne Harbour Re-Wired",u:"https://www.acon.org.au/who-we-are-here-for/alcohol-other-drugs",t:"+61 2 9206 2000",d:"LGBTQ-specific drug & chemsex support, NSW + VIC.",h:"Business hours"},
        {n:"Crystal Meth Anonymous AU",u:"https://www.crystalmeth.org.au",t:"Meetings",d:"12-step fellowship for crystal meth recovery.",h:"Daily"}
      ],
      psy:[
        {n:"QLife",u:"https://qlife.org.au",t:"1800 184 527",d:"National LGBTIQ+ peer support and referral.",h:"15h–24h"},
        {n:"Beyond Blue",u:"https://www.beyondblue.org.au",t:"1300 22 4636",d:"National mental health support.",h:"24/7"},
...
// 1. Créer un compte sur https://formspree.io avec office@moneypenis.com
...
function SimpleContactForm({t,lang}){
  ...
  const onSubmit=async(e)=>{
    ...
    setSending(false);
    const href=`mailto:andre@moneypenis.com,sebastien@moneypenis.com?subject=${encodeURIComponent(`Contact — ${d.nom} ${d.prenom}`)}&body=${encodeURIComponent(summary)}`;
    ...
    <form onSubmit={onSubmit} style={{textAlign:"left"}}>
      ...
      <div style={{padding:"14px 16px",border:"1px solid #0a1228",marginBottom:16}}>
        <p style={{color:"#0a1228",fontSize:11,lineHeight:1.7,marginBottom:10,
          fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
          Les informations recueillies sont destinées à Sébastien Moreu et Andre Vaszkievicz, responsables du traitement, dans le seul but de répondre à votre demande et, le cas échéant, de vous informer de l'évolution de leurs projets. Conformément au RGPD, vous disposez d'un droit d'accès, de rectification et de suppression de vos données en écrivant à <strong>office@moneypenis.com</strong>.
        </p>
...
function ContactForm({t,lang,d,setD,matrix,setMatrix,result,setResult,onContinue,onSuccess}){
  ...
  // Récap résumé envoyé à office@moneypenis.com
  const buildSummary=()=>{
    const dt=new Date().toLocaleString("fr-FR",{
      day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"});
  ...
  const onSubmit=async(e)=>{
    ...
    setSending(false);
    const href=`mailto:andre@moneypenis.com,sebastien@moneypenis.com?subject=${encodeURIComponent(`Demande — ${d.nom} ${d.prenom}`)}&body=${encodeURIComponent(summary)}`;
    window.location.href=href;
    setResult("ok");
  };
...
function SOSButton({onClick,size=26}){
  return (
    <button onClick={onClick}
      title="SOS — Prévention & Urgence / Prevention & Emergency"
      aria-label="SOS"
      style={{display:"inline-flex",alignItems:"center",justifyContent:"center",
        width:size,height:size,background:"#dc2626",color:"#ffffff",
        border:"none",borderRadius:4,
        fontSize:size>=32?11:9,fontWeight:700,letterSpacing:0.5,
...
function PatchworkGrid(){
  ...
  useEffect(()=>{
    const update=()=>{
      ...
      if(w>=1100)setGridCols(6);
      else if(w>=800)setGridCols(5);
      else if(w>=600)setGridCols(4);
      else if(w>=400)setGridCols(3);
      else setGridCols(2);
    };
    update();
  ...
  // Tailles + insertion fillers intermédiaires
  ...
  // Spans effectifs clipés à gridCols (un L=3×3 devient 2×2 si on n'a que 2 cols)
  const getSpan=(size)=>{
    const base=size==="L"?{c:3,r:3}:size==="M"?{c:2,r:2}:{c:1,r:1};
    return{c:Math.min(base.c,gridCols),r:Math.min(base.r,gridCols)};
  };

  // Cells totales utilisées (estimation pour finir droit)
  const totalCells=items.reduce((s,it)=>{
    const sp=getSpan(it.size);
    return s+sp.c*sp.r;
  },0);
  const remainder=totalCells%gridCols;
  const fillersToAdd=remainder===0?0:(gridCols-remainder);
  // Fillers de fin pour finir droit
  const endColors=["#ffffff","#5fbfb0","#f068a8","#ffffff","#f068a8","#5fbfb0"];
  for(let i=0;i<fillersToAdd;i++){
    items.push({type:"filler",color:endColors[i%endColors.length],size:"S"});
  }
  ...
  return(
    <div style={{
      ...
      {items.map((item,i)=>{
        const sp=getSpan(item.size);
        const base={
          gridColumn:`span ${sp.c}`,
          gridRow:`span ${sp.r}`,
          overflow:"hidden"
        };
        if(item.type==="filler"){
...
export default function App(){
  ...
  const goSec=(s)=>{setSec(s);setMenuOpen(false);setLangOpen(false);setInstallOS(null);};
  ...
  return(
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#ffffff",
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .nb{background:none;border:none;color:#0a1228;
          ...
          white-space:normal;}
        .nb.huge{font-size:clamp(36px,7vmin,72px);line-height:1.05;font-weight:400;}
        .nb.big {font-size:clamp(20px,3.6vmin,36px);}
        .nb.med {font-size:clamp(17px,2.8vmin,26px);}
        .nb.sml {font-size:clamp(13px,2vmin,19px);}
        .nb.aub {font-size:clamp(32px,5vmin,56px);line-height:1;}
        @media (max-width:600px) and (orientation:portrait){
          .nb.aub{top:64% !important;left:5% !important;right:auto !important;}
        }
      ...
      {!dis&&(
        <div style={{position:"fixed",inset:0,zIndex:9999,background:"#ffffff",
          ...
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,fontSize:10,
            ...
            Sébastien Moreu & Andre Vaszkievicz · Paris 2024
          </p>
          ...
          <div style={{maxWidth:520,width:"100%",marginBottom:18,textAlign:"left",
            ...
            {(()=>{
              ...
              return t.naf.split("\n\n").map((para,j)=>{
                ...
                const renderWithBtns=(s)=>s.split(/(\{\{SOS\}\}|\{\{LEGAL\}\})/).map((seg,k)=>{
                  if(seg==="{{SOS}}")return <span key={k} style={{display:"inline-flex",verticalAlign:"middle",margin:"0 3px"}}><SOSButton size={18} onClick={()=>goSec("prevention")}/></span>;
                  if(seg==="{{LEGAL}}")return <span key={k} style={{display:"inline-flex",verticalAlign:"middle",margin:"0 3px"}}><LegalButton size={18} onClick={()=>goSec("legal")}/></span>;
                  return seg;
                });
                return(
                  <p key={j} style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                    fontSize:11,color:"#0a1228",lineHeight:1.7,marginBottom:9}}>
                    {idx>=0?(<>{renderWithBtns(para.slice(0,idx))}<strong style={{fontWeight:700}}>{a}</strong>{renderWithBtns(para.slice(idx+a.length))}</>):renderWithBtns(para)}
                  </p>
                );
              });
            })()}
      ...
      {menuOpen&&(
        <div style={{position:"fixed",inset:0,zIndex:790,
          ...
          <div style={{position:"relative",width:"100%",height:"100%"}}>
            {(() => {
              const items=[
                {sk:"bio",        side:"left",  pos:8,  top:8,  size:"big",  fsOver:"clamp(22px,4.3vmin,42px)", maxW:"60vw", label: t.nav[5]||"De jolies plumes vraiment…"},
                {sk:"coffret",    side:"right", pos:11, top:15, size:"sml",                                   maxW:"42vw", label: t.nav[2]||"Les précieux coffrets"},
                {sk:"contact",    side:"left",  pos:14, top:23, size:"sml",  fsOver:"clamp(12px,1.8vmin,17px)", maxW:"40vw", label: t.nav[7]||"I love you too"},
                {sk:"shop",       side:"right", pos:15, top:30, size:"big",                                   maxW:"54vw", label: t.nav[4]||"Le prix des aubergines"},
                {sk:"install",    side:"left",  pos:10, top:38, size:"sml",  fsOver:"clamp(13px,2vmin,18px)",    maxW:"50vw", label: t.appT||"La Belle et L'Appli"},
                {sk:"jeu",        side:"left",  pos:22, top:50, size:"aub",  fsOver:"clamp(48px,8.5vmin,100px)",maxW:"30vw", label:"🍆"},
                {sk:"portfolio",  side:"center",         top:56, size:"huge",                                 maxW:"86vw", label: t.nav[0]||"I Love You Moneypenis", twoLine:true},
                {sk:"insitu",     side:"right", pos:19, top:69, size:"sml",  fsOver:"clamp(16px,2.6vmin,24px)", maxW:"46vw", label: t.nav[3]||"In Situ aimes ça"},
                {sk:"signatures", side:"left",  pos:17, top:77, size:"sml",                                   maxW:"50vw", label: t.nav[9]||"Des feutres et des mains"},
                {sk:"video",      side:"right", pos:15, top:84, size:"big",  fsOver:"clamp(18px,3.2vmin,30px)", maxW:"54vw", label: t.nav[1]||"Le Clip Teaser"},
              ...
              <div style={{maxWidth:1100,margin:"0 auto",padding:"24px 18px 40px"}}>
                <div style={{display:"grid",
                  ...
                  <div onClick={()=>setShopView("pf")}
                    ...
                    <p style={{color:"#0a1228",fontSize:14,fontWeight:600,marginBottom:4,
                      ...
                      {EDS[0].pr.port.toLocaleString("fr-FR")} € <span style={{fontSize:10,fontWeight:400,opacity:.7}}>{t.priceUnit||"TTC"}</span>
                    </p>
                  ...
                  <div onClick={()=>setShopView("gf")}
                    ...
                    <p style={{color:"#0a1228",fontSize:14,fontWeight:600,marginBottom:4,
                      fontFamily:"'Space Grotesk',sans-serif"}}>
                      {EDS[1].pr.port.toLocaleString("fr-FR")} € <span style={{fontSize:10,fontWeight:400,opacity:.7}}>{t.priceUnit||"TTC"}</span>
                    </p>
                    <p style={{color:"#0a1228",fontSize:10,opacity:.7,marginBottom:4,
                      fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
                ...
                <div style={{textAlign:"center",padding:"40px 0 0",maxWidth:520,margin:"0 auto"}}>
                  ...
                  <p style={{color:"#0a1228",fontSize:10,opacity:.7,marginTop:6,
                    ...
                    lineHeight:1.7}}>
                    {(() => {
                      const parts = (t.siPro||"").split(/\[([^\]]+)\]/);
                      return parts.map((p, i) => i % 2 === 1
                        ? <a key={i} href="#contact"
                             onClick={(e)=>{e.preventDefault();goSec("contact");setTimeout(()=>window.scrollTo({top:0,behavior:"smooth"}),50);}}
                             style={{color:"#0a1228",textDecoration:"underline",cursor:"pointer",fontStyle:"italic"}}>{p}</a>
                        : p);
                    })()}
                  </p>
                </div>
              ...
              return(
                <div style={{maxWidth:900,margin:"60px auto",padding:"0 18px 70px"}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:36,
                    ...
                    <div>
                      <p style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:500,fontSize:9,
                        letterSpacing:5,color:"#0a1228",marginBottom:18,textTransform:"uppercase"}}>
                        I.L.Y.M. · {p.num}
                      </p>
                      <p style={{color:"#0a1228",fontSize:13,lineHeight:1.8,marginBottom:18,
                        ...
                        {t.tech_info||"2024 · 30 × 40 cm (50 ex.) · 50 × 70 cm (15 ex.) · Tirage argentique · Traphot, Montrouge"}
                      </p>
        ...
        <div style={{maxWidth:1280,margin:"60px auto",padding:"0 18px 70px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",
            ...
            <div style={{width:110,height:110,borderRadius:"50%",overflow:"hidden",
              ...
              <img src={IMG.portrait_duo} alt="Sébastien & Andre" draggable={false}
                onContextMenu={e=>e.preventDefault()}
                style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}}/>
            </div>
      ...
      {/* ══ INSTALL APP ═════════════════════════════════════════════════════ */}
      {sec==="install"&&(
        <div style={{maxWidth:560,margin:"60px auto",padding:"0 20px 70px",textAlign:"center"}}>
          <h2 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",fontWeight:400,
            fontSize:"clamp(24px,4.5vw,40px)",marginBottom:10,color:"#0a1228"}}>
            {t.appT||"La Belle et L'Appli"}
          </h2>
          <p style={{color:"#0a1228",fontSize:14,lineHeight:1.6,maxWidth:460,
            margin:"0 auto 44px",opacity:.85}}>
            {t.appS}
          </p>

          {!installOS&&(
            <>
              <p style={{color:"#0a1228",fontSize:11,letterSpacing:2,textTransform:"uppercase",
                marginBottom:24,fontFamily:"'Space Grotesk',sans-serif",opacity:.7}}>
                {t.appPick}
              </p>
              <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
                <button onClick={()=>setInstallOS("ios")}
                  style={{padding:"26px 30px",background:"#fff",border:"1px solid #0a1228",
                    cursor:"pointer",fontSize:13,letterSpacing:1.5,
                    fontFamily:"'Space Grotesk',sans-serif",color:"#0a1228",minWidth:170}}>
              ...
              <div style={{marginTop:56,paddingTop:36,borderTop:"1px solid rgba(10,18,40,0.18)",maxWidth:300,marginLeft:"auto",marginRight:"auto"}}>
                <p style={{color:"#0a1228",fontSize:11,letterSpacing:2,textTransform:"uppercase",
                  marginBottom:18,fontFamily:"'Space Grotesk',sans-serif",opacity:.7}}>
                  {t.appScan||"Scan with your phone"}
                </p>
                <img
                  src="https://api.qrserver.com/v1/create-qr-code/?size=240x240&data=https%3A%2F%2Fmoneypenis.com&margin=2&color=0A1228"
                  alt="QR moneypenis.com"
                  style={{width:160,height:160,display:"block",margin:"0 auto 16px",background:"#fff"}}
                />
                <a href="https://moneypenis.com" target="_blank" rel="noopener noreferrer"
                  style={{color:"#0a1228",fontSize:13,fontFamily:"'Space Grotesk',sans-serif",
                    letterSpacing:1.5,textDecoration:"none",borderBottom:"1px solid rgba(10,18,40,0.4)",
            ...
            <div style={{textAlign:"left",maxWidth:440,margin:"0 auto"}}>
              <button onClick={()=>setInstallOS(null)}
                style={{background:"none",border:"none",cursor:"pointer",color:"#0a1228",
                  fontSize:12,padding:"6px 0",marginBottom:26,
                  fontFamily:"'Space Grotesk',sans-serif",letterSpacing:1}}>
                {t.appBack}
              </button>
              <h3 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
                fontWeight:400,fontSize:20,marginBottom:22,color:"#0a1228"}}>{t.appIosT}</h3>
              <ol style={{paddingLeft:24,color:"#0a1228",fontSize:14,lineHeight:2,
                fontFamily:"'Space Grotesk',sans-serif"}}>
                <li>{t.appIos1}</li>
                <li>{t.appIos2}</li>
                <li>{t.appIos3}</li>
          ...
          {installOS==="android"&&(
            <div style={{textAlign:"left",maxWidth:440,margin:"0 auto"}}>
              ...
              <h3 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
                fontWeight:400,fontSize:20,marginBottom:22,color:"#0a1228"}}>{t.appAndT}</h3>
              <ol style={{paddingLeft:24,color:"#0a1228",fontSize:14,lineHeight:2,
                fontFamily:"'Space Grotesk',sans-serif"}}>
                <li>{t.appAnd1}</li>
                <li>{t.appAnd2}</li>
        ...
        return (
          <div style={{maxWidth:1100,margin:"0 auto",padding:"0 18px 60px"}}>
            ...
            <div style={{background:"#dc2626",color:"#ffffff",padding:"18px 22px",
              borderRadius:6,marginTop:30,marginBottom:24,
              display:"flex",alignItems:"center",gap:14,flexWrap:"wrap"}}>
              <span style={{fontSize:24,fontWeight:700,letterSpacing:1,
                fontFamily:"'Space Grotesk',sans-serif"}}>SOS</span>
              <p style={{margin:0,fontSize:13,lineHeight:1.6,flex:1,minWidth:200,
                fontFamily:"'Space Grotesk',sans-serif",fontWeight:400}}>
                {L.sub}
              </p>
            </div>
            ...
            <div style={{textAlign:"center",marginBottom:30}}>
              <h1 style={{fontFamily:"'Libre Baskerville',serif",fontStyle:"italic",
                fontWeight:400,fontSize:"clamp(28px,5vw,52px)",lineHeight:1.2,
                color:"#0a1228",marginBottom:14}}>{L.title}</h1>
              <div style={{width:36,height:1,background:"#0a1228",margin:"0 auto 16px"}}/>
              {showPh3 && (
                <p style={{color:"#0a1228",fontSize:11,lineHeight:1.6,opacity:0.7,
                  maxWidth:560,margin:"0 auto 8px",fontStyle:"italic",
                  fontFamily:"'Space Grotesk',sans-serif"}}>
                  {L.ph3}
                </p>
              )}
            ...
            <div style={{display:"flex",justifyContent:"center",flexWrap:"wrap",
              ...
              {countries.map(c=>(
                <button key={c.code} onClick={()=>setPrevCountry(c.code)}
                  style={{background:prevCountry===c.code?"#0a1228":"#ffffff",
                    color:prevCountry===c.code?"#ffffff":"#0a1228",
                    border:"1px solid #0a1228",padding:"10px 18px",
                    fontFamily:"'Space Grotesk',sans-serif",fontWeight:500,
            ...
            {(()=>{
              ...
              return (
                <div>
                  {order.map(catKey=>{
                    const items = sel.cats[catKey];
                    if(!items || items.length===0) return null;
                    const isVital = (catKey==="suicide"||catKey==="minors");
                    return (
                      <div key={catKey} style={{marginBottom:36}}>
                        <div style={{display:"flex",alignItems:"baseline",gap:10,
                          marginBottom:14,paddingBottom:6,
                          borderBottom:`1px solid ${isVital?"#dc2626":"#0a1228"}`}}>
                          {isVital && (
                          ...
                          <h2 style={{fontFamily:"'Libre Baskerville',serif",
                            ...
                            fontSize:"clamp(18px,2.6vw,26px)",color:"#0a1228",margin:0}}>
                            {L.cat[catKey]}
                          </h2>
                        </div>
                        {(()=>{
                          ...
                          const renderCard = (r,i)=>(
                            <div key={i} style={{background:"#ffffff",
                              ...
                              <p style={{fontFamily:"'Space Grotesk',sans-serif",
                                fontWeight:600,fontSize:13,color:"#0a1228",
                                marginBottom:6,lineHeight:1.3}}>
                                {r.n}
                              </p>
                              <p style={{fontFamily:"'Space Grotesk',sans-serif",
                                fontWeight:400,fontSize:11,color:"#0a1228",
                                lineHeight:1.5,marginBottom:10,opacity:0.85}}>
                                {r.d}
                              </p>
                              <div style={{display:"flex",flexDirection:"column",gap:4}}>
                                {r.t && (
                                  <a href={r.t.match(/^[0-9+\s]/) ? `tel:${r.t.replace(/[^0-9+]/g,"")}` : "#"}
                                    onClick={e=>{if(!r.t.match(/^[0-9+\s]/))e.preventDefault();}}
                                    style={{color:isVital?"#dc2626":"#0a1228",
                                      fontFamily:"'Space Grotesk',sans-serif",fontWeight:700,
                                      fontSize:13,textDecoration:"none",lineHeight:1.3}}>
                                    📞 {r.t}
                                  </a>
                                )}
                                <a href={r.u} target="_blank" rel="noopener noreferrer"
                                  style={{color:"#0a1228",
                                    fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                                    fontSize:11,textDecoration:"underline",lineHeight:1.3,
                                    wordBreak:"break-all"}}>
                                  {r.u.replace(/^https?:\/\//,"")}
                                </a>
                                {r.h && (
                                  <p style={{margin:0,
                                    fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                                    fontSize:10,color:"#0a1228",opacity:0.6,fontStyle:"italic"}}>
                                    {r.h}
                                  </p>
                                )}
                              </div>
            ...
            <div style={{textAlign:"center",marginTop:40,paddingTop:24,
              ...
              <p style={{color:"#0a1228",fontSize:10,opacity:0.6,lineHeight:1.6,
                maxWidth:560,margin:"0 auto",fontStyle:"italic",
                fontFamily:"'Space Grotesk',sans-serif"}}>
                {L.note}
              </p>
              <button onClick={()=>goSec("portfolio")} className="bg"
                style={{marginTop:24,display:"inline-block",width:"auto"}}>
                ← {L.backHome}
              </button>
            </div>
          </div>
      ...
      <footer style={{borderTop:"1px solid #0a1228",
        ...
        <div style={{display:"flex",alignItems:"center",gap:7}}>
          ...
          <div style={{display:"flex",flexDirection:"column",alignItems:"flex-start",gap:2}}>
            ...
            <a href="mailto:office@moneypenis.com"
              style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,
                fontSize:8,letterSpacing:.5,color:"#0a1228",textDecoration:"none"}}>
              office@moneypenis.com
            </a>
          </div>
        </div>
