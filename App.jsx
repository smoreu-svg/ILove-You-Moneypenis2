    ...
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#ffffff",
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        /* Bandeau "traduction IA" : défilement horizontal, n'intercepte pas les clics */
        .ai-warn-banner {
      ...
      {/* ══ BANDEAU IA : ne s'affiche que pour les langues traduites par IA ════ */}
      {lang!=="FR"&&(
        <div className="ai-warn-banner" aria-hidden="true">
