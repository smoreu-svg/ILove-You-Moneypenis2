    ...
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#fafafa",
      ...
      {!dis&&(
        <div style={{position:"fixed",inset:0,zIndex:9999,background:"#fafafa",
          ...
          {/* Lang picker (fades in après intro) — position:fixed pour rester ancré
              au viewport, le parent est en overflowY:auto donc absolute scrollait
              avec le contenu de l'avertissement */}
          <div className="fade-in" style={{position:"fixed",top:"calc(14px + env(safe-area-inset-top,0px))",
            ...
            background:"#fafafa",padding:6,border:"1px solid #cfcbc4",zIndex:5}}>
            {LANGS.map(l=>(
              <button key={l}
