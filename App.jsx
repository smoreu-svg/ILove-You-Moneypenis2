    ...
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#fafafa",
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @keyframes introBounce {
          ...
          5%   { opacity: 1; }
          20%  { transform: scale(8) rotate(120deg); }
          30%  { transform: scale(0.3) rotate(240deg); }
          40%  { transform: translate(36vw, 26vh) scale(0.45) rotate(420deg); }
          50%  { transform: translate(36vw, 56vh) scale(0.45) rotate(600deg); }
          60%  { transform: translate(-36vw, 56vh) scale(0.5) rotate(780deg); }
          70%  { transform: translate(-36vw, 26vh) scale(0.5) rotate(960deg); }
          80%  { transform: translate(0, 32vh) scale(0.6) rotate(1140deg); }
          90%  { transform: scale(1.18) rotate(1320deg); }
          100% { transform: scale(1) rotate(1440deg); opacity: 1; }
        }
        .intro-logo { animation: introBounce 3.6s ease-in-out forwards; transform-origin: 50% 50%; }
      ...
      {!dis&&(
        <div style={{position:"fixed",inset:0,zIndex:9999,background:"#fafafa",
          ...
          <div className={introDone?"":"intro-logo"}
