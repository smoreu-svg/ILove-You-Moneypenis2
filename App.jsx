  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(251,251,248,0.98)",zIndex:3000,
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",
        padding:"10px 16px",borderBottom:"1px solid #cfcbc4",background:"#fafaf6",
      ...
      <div style={{flex:1,overflow:"hidden",display:"flex",flexDirection:"column"}}
        ...
        <div ref={imgRef} onClick={handleImgClick}
          style={{flex:1,overflow:"hidden",cursor:zoomed?"zoom-out":"zoom-in",
            display:"flex",alignItems:"center",justifyContent:"center",background:"#fafaf6"}}>
      ...
      {/* Footer nav */}
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",
        padding:"8px 16px",borderTop:"1px solid #cfcbc4",background:"#fafaf6",
...
export default function App(){
  ...
  return(
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#fafaf6",
      ...
      {/* ══ AGE GATE ══════════════════════════════════════════════════════════ */}
      {!dis&&(
        <div style={{position:"fixed",inset:0,zIndex:9999,background:"#fafaf6",
            ...
            <div style={{position:"relative"}}>
              ...
              {langOpen&&(
                <div style={{position:"absolute",top:"calc(100% + 4px)",right:0,
                  background:"#fafaf6",border:"1px solid #cfcbc4",zIndex:900,
                  minWidth:52,boxShadow:"0 4px 20px rgba(0,0,0,0.08)"}}>
                  {LANGS.filter(l=>l!==lang).map(l=>(
                    <button key={l}
                      onClick={()=>{setLang(l);setLangOpen(false);}}
                      style={{display:"block",width:"100%",background:"none",border:"none",
                        borderBottom:"1px solid #fafaf6",padding:"9px 0",fontSize:9,
          ...
          <div id="pg" style={{display:"flex",flexDirection:"column"}}>
            {PRINTS.map((p,idx)=>(
              <div key={p.id} className="hs"
                ...
                <div style={{flexShrink:0,width:"32%",maxWidth:200,background:"#fafaf6"}}>
                  <PImg src={p.src} ageOk={ageOk} bz={p.bz}/>
                </div>
      ...
      <footer style={{borderTop:"1px solid #cfcbc4",
        ...
        background:"#fafaf6",display:"flex",justifyContent:"space-between",
