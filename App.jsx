...
function ContactForm({t,lang}){
  const[d,setD]=useState({
    nom:"",prenom:"",email:"",phone:"",country:"",langPref:lang,
    pref:"email",msg:"",consent:false
  });
  // Matrice : chaque case = boolean. clé = `${œuvreId}|${typeId}`
  ...
  return(
    <div style={{fontFamily:"'Space Grotesk',sans-serif",background:"#ffffff",
      ...
      {sec==="shop"&&(
        ageOk ? (
          <>
            {/* Bandeau d'en-tête type portfolio */}
            ...
            {/* Catalogue : 3 sections en colonnes élégantes */}
            <div style={{maxWidth:1100,margin:"0 auto",padding:"24px 18px 0"}}>
              ...
              <div style={{textAlign:"center",padding:"30px 0 18px"}}>
                <button onClick={()=>goSec("contact")} className="bg"
                  style={{display:"inline-block",width:"auto"}}>
                  {t.req}
                </button>
                <p style={{color:"#0a1228",fontSize:10,opacity:.7,marginTop:18,
                  fontFamily:"'Space Grotesk',sans-serif",fontWeight:400,lineHeight:1.7,
                ...
                <p style={{color:"#0a1228",fontSize:10,opacity:.7,marginTop:6,
                  ...
                  lineHeight:1.7,maxWidth:520,margin:"6px auto 0"}}>
                  {t.siPro}
                </p>
              </div>
            </div>
